                  ...
                  <span class="input-group-text">
                    <i class="fa-solid fa-lg fa-user"></i>
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-12">
                                <button type="submit"
                                        class="btn btn-primary btn-lg"><?php echo TEXT_BUTTON_REQUEST_RESET; ?></button>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <div class="col-12">
                                <a href="<?php echo zen_href_link(FILENAME_LOGIN); ?>" class="btn btn-secondary btn-lg"
                                   role="button"><?php echo TEXT_BUTTON_CANCEL; ?></a>
                            </div>
                        </div>
                    <?php } else { ?>
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-12">
                                <button type="submit"
                                        class="btn btn-primary btn-lg"><?php echo TEXT_BUTTON_LOGIN; ?></button>
                            </div>
                        </div>
                    <?php } ?>
                    <br class="clearBoth">
