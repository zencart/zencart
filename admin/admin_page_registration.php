  ...
  <body>
    ...
    <div class="container-fluid" id="pageWrapper">
      ...
      <div class="form-group row mb-3">
          <?php echo zen_draw_label(TEXT_PAGE_KEY, 'page_key', 'class="col-sm-3 form-label"'); ?>
      ...
      <div class="form-group row mb-3">
          <?php echo zen_draw_label(TEXT_LANGUAGE_KEY, 'language_key', 'class="col-sm-3 form-label"'); ?>
        <div class="col-sm-9 col-md-6">
      ...
      <div class="form-group row mb-3">
          <?php echo zen_draw_label(TEXT_MAIN_PAGE, 'main_page', 'class="col-sm-3 form-label"'); ?>
        <div class="col-sm-9 col-md-6">
      ...
      <div class="form-group row mb-3">
          <?php echo zen_draw_label(TEXT_PAGE_PARAMS, 'page_params', 'class="col-sm-3 form-label"'); ?>
        <div class="col-sm-9 col-md-6">
      ...
      <div class="form-group row mb-3">
          <?php echo zen_draw_label(TEXT_MENU_KEY, 'menu_key', 'class="col-sm-3 form-label"'); ?>
        <div class="col-sm-9 col-md-6">
            <?php echo zen_draw_pull_down_menu('menu_key', $menu_options, $menu_key, 'class="form-control" id="menuKey" required'); ?>
        </div>
      </div>
      <div class="form-group row mb-3">
          <?php echo zen_draw_label(TEXT_DISPLAY_ON_MENU, 'display_on_menu', 'class="col-sm-3 form-label"'); ?>
        <div class="col-sm-9 col-md-6">
          <input type="checkbox" name="display_on_menu" id="displayOnMenu" <?php echo $checked ?>>
        </div>
      </div>
      <div class="form-group row mb-3">
          <?php echo zen_draw_label(TEXT_SORT_ORDER, 'sort_order', 'class="col-sm-3 form-label"'); ?>
