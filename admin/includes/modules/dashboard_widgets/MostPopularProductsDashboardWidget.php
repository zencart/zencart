        ...
        <ul class="list-group">
            <?php foreach ($top_products as $top_product) {
                ...
                if (empty($img) || !file_exists(DIR_FS_CATALOG_IMAGES . $img)) {
                    ...
                    $thumb = zen_image(DIR_WS_CATALOG_IMAGES . $img, $name, zen_config('IMAGE_SHOPPING_CART_WIDTH'), zen_config('IMAGE_SHOPPING_CART_HEIGHT'), 'class="most-popular-main-image object-fit-contain"');
                }
                ?>
