...
$parameters = [
  ...
  'products_price_w' => '0',
  'products_virtual' => zen_config('DEFAULT_PRODUCT_FREE_SHIPPING_PRODUCTS_VIRTUAL'),
  'products_weight' => '0',
  'products_length' => '',
  'products_width' => '',
  'products_height' => '',
  ...
  'products_status' => '1',
  'products_tax_class_id' => zen_config('DEFAULT_PRODUCT_FREE_SHIPPING_TAX_CLASS_ID'),
  'manufacturers_id' => '',
  ...
  'product_is_always_free_shipping' => zen_config('DEFAULT_PRODUCT_FREE_SHIPPING_PRODUCTS_IS_ALWAYS_FREE_SHIPPING'),
...
// hidden fields not changeable on products page
  ...
  <div class="form-group">
      <?= zen_draw_label(TEXT_PRODUCTS_MANUFACTURER, 'manufacturers_id', 'class="col-sm-3 control-label"') ?>
    <div class="col-sm-9 col-md-6">
        <?= zen_draw_pull_down_menu('manufacturers_id', $manufacturers_array, $pInfo->manufacturers_id, 'class="form-control" id="manufacturers_id"') ?>
    </div>
  </div>
  <div class="form-group">
