...
<!-- bof: products_previous_next_display -->
  <tr>
    <td><table border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <?php if ($counter > 0 ) { ?>
          <td align="center" class="main"><a href="<?php echo zen_admin_href_link($curr_page, "products_filter=" . $previous . '&current_category_id=' . $current_category_id); ?>"><?php echo zen_image_button('button_prev.gif', BUTTON_PREVIOUS_ALT); ?></a>&nbsp;&nbsp;</td>
        <?php } ?>
        ...
        <?php if ($counter > 0 ) { ?>
          <td align="center" class="main">&nbsp;&nbsp;<a href="<?php echo zen_admin_href_link($curr_page, "products_filter=" . $next_item . '&current_category_id=' . $current_category_id); ?>"><?php echo zen_image_button('button_next.gif', BUTTON_NEXT_ALT); ?></a></td>
        <?php } ?>
      </tr>
    </table></td>
  </tr>
