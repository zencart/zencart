...
// if invalid product id skip
  ...
  switch(true) {
  case (strstr($PHP_SELF, FILENAME_ATTRIBUTES_CONTROLLER) || Request::readGet('cmd') == FILENAME_ATTRIBUTES_CONTROLLER):
    $curr_page = FILENAME_ATTRIBUTES_CONTROLLER;
    break;
  case (strstr($PHP_SELF, FILENAME_PRODUCTS_TO_CATEGORIES) || Request::readGet('cmd') == FILENAME_PRODUCTS_TO_CATEGORIES):
