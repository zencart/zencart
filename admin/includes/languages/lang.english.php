...
$define = [
    ...
    'ERROR_EDITOR_NOT_FOUND' => 'The HTML editor currently selected (%s) in \'My Store\' is not available. The site\'s default editor will be non-HTML until you update that selection to an available HTML editor.',
