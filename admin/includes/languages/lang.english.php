...
$define = [
    ...
    'ERROR_MYSQL_EVENT_PRIVILEGE_NEEDED' => 'You need MySQL EVENT privilege to schedule a product available date. Please, adjust your current user privileges to include EVENT. No schedule has been set, modified or deleted. If you have scheduled an event like a product release date, it will not be applied!',
    'ERROR_MYSQL_EVENT_SCHEDULER_NOT_ACTIVATED' => 'MySQL Event Scheduler is not activated. No schedule has been set, modified or deleted. If you have scheduled an event like a product release date, it will not be applied!',
