...
$define = [
    'HEADING_TITLE' => 'Option Value Sorter',
    'TABLE_HEADING_OPTION_VALUE_ID' => 'Option Value ID',
    'TABLE_HEADING_OPTION_VALUE_NAME' => 'Option Value Name',
    'TEXT_UPDATE_OPTION_VALUES' => 'Update Option Value Default Sort Orders for an Option Name',
    'TEXT_SELECT_OPTION' => 'Option Name:',
    ...
    'SUCCESS_OPTION_VALUES_SORT_ORDER_NAME' => 'Option Name "%1$s" (#%2$s): Option Value "%3$s" (#%4$s), sort order = %5$s',
