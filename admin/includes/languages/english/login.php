...
define('LOGIN_EXPIRY_NOTICE', 'Please be aware that after ' . SESSION_TIMEOUT_ADMIN/60 . ' minutes of inactivity, you will be required to login again.<br /><br />Note: All passwords expire after 90 days, at which time you will be prompted for a new password.');
