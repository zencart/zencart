...
$define = [
    ...
    'SUCCESS_PRODUCT_UPDATE_PRODUCTS_VIEWED' => '<strong>Purged</strong> all Product Views history.',
    ...
    'TEXT_INFO_PRODUCTS_VIEWED_UPDATE' => '<strong>Reset ALL Product Views History</strong><br>Purge all Product Views records: ',
    ...
    'TEXT_INFO_SET_NEXT_ORDER_NUMBER' => '<strong>Set the next order number</strong><br>NOTE: It must be greater than %u.',
