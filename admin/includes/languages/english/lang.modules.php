...
$define = [
    ...
    'TEXT_EMAIL_SUBJECT_ADMIN_SETTINGS_CHANGED' => 'ALERT: Admin settings have been changed in "' . zen_config('STORE_NAME') . '"',
    'TEXT_EMAIL_MESSAGE_ADMIN_SETTINGS_CHANGED' => 'This is an automated email from "' . zen_config('STORE_NAME') . '" to alert you of a change that was just made to your administrative settings: ' . "\n\n" . 'NOTE: Admin settings have been CHANGED for the [%1$s] module, by Zen Cart admin user %2$s.' . "\n\n" . 'If you did not initiate these changes, it is advisable that you verify the settings immediately.' . "\n\n" . 'If you are already aware of these changes, you can ignore this automated email.',
    'TEXT_EMAIL_MESSAGE_ADMIN_MODULE_INSTALLED' => 'This is an automated email from "' . zen_config('STORE_NAME') . '" to alert you of a change that was just made to your administrative settings: ' . "\n\n" . 'NOTE: Admin settings have been changed. The [%1$s] module has been INSTALLED by Zen Cart admin user %2$s.' . "\n\n" . 'If you did not initiate these changes, it is advisable that you verify the settings immediately.' . "\n\n" . 'If you are already aware of these changes, you can ignore this automated email.',
    'TEXT_EMAIL_MESSAGE_ADMIN_MODULE_REMOVED' => 'This is an automated email from "' . zen_config('STORE_NAME') . '" to alert you of a change that was just made to your administrative settings: ' . "\n\n" . 'NOTE: Admin settings have been changed. The [%1$s] module has been REMOVED by Zen Cart admin user %2$s.' . "\n\n" . 'If you did not initiate these changes, it is advisable that you verify the settings immediately.' . "\n\n" . 'If you are already aware of these changes, you can ignore this automated email.',
