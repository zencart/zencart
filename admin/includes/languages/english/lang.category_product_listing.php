...
$define = [
    ...
    'TEXT_DELETE_WARNING_CHILDS' => '<b>WARNING:</b> Category has subcategories',
    'TEXT_DELETE_WARNING_PRODUCTS' => '<b>WARNING:</b> There are %s products still under this category!',
