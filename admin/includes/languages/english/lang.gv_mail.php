...
$define = [
    ...
    'TEXT_TO_EMAIL_INFO' => '<span class="smallText">Choose a list from the above drop-down or use the following fields for sending a single email.</span>',
    'TEXT_SUBJECT' => 'Subject:',
    'TEXT_AMOUNT' => '%%TEXT_GV_NAME%%' . ' Value:',
    'ERROR_GV_AMOUNT' => '<span class="smallText">Enter a number using a decimal point for fractions eg.: 25.00.</span>',
