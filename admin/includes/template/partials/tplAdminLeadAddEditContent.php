...
<div class="large-10 columns">
      <div class="panel">
      <?php echo zen_draw_form('AdminLeadAddEditContentForm', $_GET['cmd'], zen_get_all_get_params(array('action')) . 'action=' . $tplVars['leadDefinition'] ['formAction'], 'post', ' data-abide ' . $tplVars['leadDefinition']['enctype'])?>
      <fieldset>
      ...
      <div class="row">
        ...
        <label class="inline" for="<?php echo $tplVars['leadDefinition']['fields'][$field]['field']; ?>"><?php echo $tplVars['leadDefinition']['fields'][$field]['layout']['title']; ?></label>
         <?php } ?>
         </div>
