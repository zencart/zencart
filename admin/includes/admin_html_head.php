...
<?php if (file_exists($value = DIR_WS_INCLUDES . 'fontawesome/css/fontawesome.min.css')) { ?>
    <link rel="stylesheet" href="<?= $value ?>">
    <link rel="stylesheet" href="<?= DIR_WS_INCLUDES ?>fontawesome/css/solid.min.css">
    <link rel="stylesheet" href="<?= DIR_WS_INCLUDES ?>fontawesome/css/regular.min.css">
...
<?php } ?>
    <link rel="stylesheet" href="<?= DIR_WS_INCLUDES ?>css/jAlert.min.css">
...
?>
        <link rel="stylesheet" href="<?= $relativeDir . 'admin/includes/css/' . $value ?>">
<?php
    }

    if (file_exists($absoluteDir  . 'admin/includes/css/' . $page_base_name . '.css')) {
?>
        <link rel="stylesheet" href="<?= $relativeDir . 'admin/includes/css/' . $page_base_name . '.css' ?>">
<?php
    }
