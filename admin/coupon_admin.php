...
// base code - create duplicate codes from base code
  ...
  case 'update':
    ...
    $is_pct = (str_ends_with($_POST['coupon_amount'], '%'));
              ...
              <table class="table table-striped table-hover">
                <thead>
                  <tr class="dataTableHeadingRow">
                    <th class="dataTableHeadingContent"><?= CUSTOMER_ID ?></th>
                    <th class="dataTableHeadingContent text-center"><?= CUSTOMER_NAME ?></th>
                    <th class="dataTableHeadingContent text-center"><?= IP_ADDRESS ?></th>
                    <th class="dataTableHeadingContent text-center"><?= REDEEM_DATE ?></th>
                    <th class="dataTableHeadingContent text-right"><?= REDEEM_ORDER_ID ?></th>
                ...
                <tbody>
                  ...
                  foreach ($cc_list as $item) {
                    ...
                    if ((isset($cInfo)) && ($item['unique_id'] == $cInfo->unique_id)) {
                      ?>
                      <tr class="dataTableRowSelected" onclick="document.location.href = '<?= zen_href_link(FILENAME_COUPON_ADMIN, zen_get_all_get_params(['cid', 'action', 'uid']) . 'cid=' . $cInfo->coupon_id . '&action=voucherreport&uid=' . $cInfo->unique_id) ?>'">
                      <?php } else { ?>
                      <tr class="dataTableRow" onclick="document.location.href = '<?= zen_href_link(FILENAME_COUPON_ADMIN, zen_get_all_get_params(['cid', 'action', 'uid']) . 'cid=' . $item['coupon_id'] . '&action=voucherreport&uid=' . $item['unique_id']) ?>'">
                        <?php
                      }
                      ...
                      <td class="dataTableContent text-right">
                        ...
                        if ((isset($cInfo)) && ($item['unique_id'] == $cInfo->unique_id)) {
                          ...
                          echo '<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'reports_page=' . $_GET['reports_page'] . '&cid=' . $item['coupon_id']) . '">' . zen_icon('circle-info', '', '2x', true) . '</a>';
                        }
                        ?>
                      </td>
                    </tr>
...
// base code - create report on matching basecode
              ...
              <table class="table table-hover table-striped">
                <thead>
                  <tr class="dataTableHeadingRow">
                    ...
                    <th class="dataTableHeadingContent text-center"><?= CUSTOMER_NAME ?></th>
                    <th class="dataTableHeadingContent text-center"><?= IP_ADDRESS ?></th>
                    <th class="dataTableHeadingContent"><?= COUPON_CODE . ' - ' . $_GET['codebase'] ?></th>
                    <th class="dataTableHeadingContent text-center"><?= REDEEM_DATE ?></th>
                    <th class="dataTableHeadingContent text-right"><?= REDEEM_ORDER_ID ?></th>
                    <th class="dataTableHeadingContent text-right"><?= TABLE_HEADING_ACTION ?></th>
                  </tr>
          ...
          case 'preview_email':
            ...
            <table class="table">
              <tr>
                <td class="text-right col-sm-3"><b><?= TEXT_CUSTOMER ?></b></td>
                <td><?= $mail_sent_to ?></td>
              </tr>
              <tr>
                <td class="text-right"><b><?= TEXT_COUPON ?></b></td>
                <td><?= zen_db_prepare_input($_POST['coupon_name']) ?></td>
              </tr>
              <tr>
                <td class="text-right"><b><?= TEXT_FROM ?></b></td>
                <td><?= htmlspecialchars(stripslashes($_POST['from']), ENT_COMPAT, CHARSET, TRUE) ?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <button type="submit" class="btn btn-primary"><?= IMAGE_SEND_EMAIL ?></button>&nbsp;<a href="<?= zen_href_link(FILENAME_COUPON_ADMIN, 'cid=' . $_GET['cid'] . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) ?>" class="btn btn-default" role="button"><?= TEXT_CANCEL ?></a>
                </td>
              </tr>
            </table>
            <?php
          ...
          case 'email':
            ...
            <div class="form-group">
              <?= zen_draw_label(TEXT_COUPON, 'coupon_name', 'class="control-label col-sm-3"') ?>
              <div class="col-sm-9 col-md-6"><?= zen_draw_input_field('coupon_name', $coupon_result->fields['coupon_name'], 'class="form-control" id="coupon_name" readonly') ?></div>
            </div>
            <?php $customers = get_audiences_list(); ?>
            <div class="form-group">
              <?= zen_draw_label(TEXT_CUSTOMER, 'customers_email_address', 'class="control-label col-sm-3"') ?>
              <div class="col-sm-9 col-md-6"><?= zen_draw_pull_down_menu('customers_email_address', $customers, ($_GET['customer'] ?? ''), 'class="form-control" id="customers_email_address"', true) ?></div>
            </div>
            <div class="form-group">
            ...
            /*
              <div class="form-group">
              <?= zen_draw_label(TEXT_RESTRICT, 'customers_restrict', 'class="control-label col-sm-3"') ?>
            ...
            ?>
            <div class="form-group">
              <?= zen_draw_label(TEXT_SUBJECT, 'subject', 'class="control-label col-sm-3"') ?>
            ...
            <?php } ?>
            <div class="form-group">
              <?= zen_draw_label(TEXT_MESSAGE, 'message', 'class="control-label col-sm-3"') ?>
              <div class="col-sm-9 col-md-6"><?= zen_draw_textarea_field('message', 'soft', '60', '15', htmlspecialchars(strip_tags((!isset($_POST['message_html']) || $_POST['message_html'] == '') ? TEXT_COUPON_ANNOUNCE : stripslashes($_POST['message_html'])), ENT_COMPAT, CHARSET, TRUE), 'class="noEditor form-control" id="message"') ?></div>
            </div>
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-9 col-md-6">
                <button type="submit" class="btn btn-primary"><?= IMAGE_PREVIEW ?></button>&nbsp;<a href="<?= zen_href_link(FILENAME_COUPON_ADMIN, 'cid=' . $_GET['cid'] . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) ?>" class="btn btn-default" role="button"><?= TEXT_CANCEL ?></a>
              </div>
            </div>
            <?php
              echo '</form>';
          ...
          case 'update_preview':
            ...
            <table class="table">
              <tr>
                <td class="main col-sm-3"><?= COUPON_ZONE_RESTRICTION ?></td>
                <td class="main"><?= zen_get_geo_zone_name($_POST['coupon_zone_restriction']) ?>
              </tr>
              <tr>
              ...
              for ($i = 0, $n = count($languages); $i < $n; $i++) {
                ...
                <tr>
                  <td><?= COUPON_NAME ?></td>
                  <td><?= zen_db_prepare_input($_POST['coupon_name'][$language_id]) ?></td>
                </tr>
                <?php
              }
              ?>
              ...
              for ($i = 0, $n = count($languages); $i < $n; $i++) {
                ...
                <tr>
                  <td><?= COUPON_DESC ?></td>
                  <td><?= zen_db_prepare_input($_POST['coupon_desc'][$language_id]) ?></td>
                </tr>
                <?php
              }
              ?>
              <tr>
                <td><?= COUPON_AMOUNT ?></td>
                <td><?= zen_db_prepare_input($_POST['coupon_amount']) . ' ' . ((int)$_POST['coupon_product_count'] == 0 ? TEXT_COUPON_PRODUCT_COUNT_PER_ORDER : TEXT_COUPON_PRODUCT_COUNT_PER_PRODUCT) ?></td>
              </tr>
              <tr>
                <td><?= COUPON_MIN_ORDER ?></td>
                <td><?= zen_db_prepare_input($_POST['coupon_min_order']) ?></td>
              </tr>
              <tr>
                <td class="main"><?= COUPON_TOTAL ?></td>
                <td>
                  <?= ((int)$_POST['coupon_calc_base'] == 0 ? TEXT_COUPON_TOTAL_PRODUCTS . TEXT_COUPON_TOTAL_PRODUCTS_BASED : TEXT_COUPON_TOTAL_ORDER . TEXT_COUPON_TOTAL_ORDER_BASED) ?>
                </td>
              </tr>
              <tr>
                <td><?= COUPON_FREE_SHIP ?></td>
                <td><?= (!empty($_POST['coupon_free_ship']) ? TEXT_FREE_SHIPPING : TEXT_NO_FREE_SHIPPING) ?></td>
              </tr>
              <tr>
                <td><?= COUPON_IS_VALID_FOR_SALES ?></td>
                <td><?= (!empty($_POST['coupon_is_valid_for_sales']) ? TEXT_COUPON_IS_VALID_FOR_SALES : TEXT_NO_COUPON_IS_VALID_FOR_SALES) ?></td>
              </tr>
              <tr>
                <td><?= COUPON_CODE ?></td>
                <td><?= $coupon_code ?></td>
              ...
              <tr>
                <td><?= COUPON_USES_COUPON ?></td>
                <td><?= $_POST['coupon_uses_coupon'] ?></td>
              </tr>
              <tr>
                <td><?= COUPON_USES_USER ?></td>
                <td><?= $_POST['coupon_uses_user'] ?></td>
              </tr>
              <tr>
                <td><?= COUPON_REFERRER ?></td>
                <td><?php
              ...
              <tr>
                <td class="text-right" colspan=2>
                  ...
                  ?>
                  <button type="submit" class="btn btn-primary" <?= empty($invalid_message) ? '' : 'disabled' ?>><?= COUPON_BUTTON_CONFIRM ?></button>&nbsp;<a href="<?= zen_href_link(FILENAME_COUPON_ADMIN, 'cid=' . $_GET['cid'] . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) ?>" class="btn btn-default" role="button"><?= TEXT_CANCEL ?></a>
                </td>
                <td></td>
              </tr>
            </table>
          ...
          case 'voucheredit':
            ...
            $coupon_free_ship = $coupon->fields['coupon_type'] == 'S' || $coupon->fields['coupon_type'] == 'O' || $coupon->fields['coupon_type'] == 'E';
...
// set some defaults
            ...
            ?>
            <div class="form-group">
          <?= zen_draw_label(COUPON_NAME, 'coupon_name[' . $languages[0]['id'] . ']', 'class="control-label col-sm-3"') ?>
              <div class="col-sm-9 col-md-6">
                <?php
                for ($i = 0, $n = count($languages); $i < $n; $i++) {
                  $language_id = $languages[$i]['id'];
                  ...
                  <div class="input-group">
                    ...
                    <?= zen_draw_input_field('coupon_name[' . $languages[$i]['id'] . ']', (!empty($coupon_name[$language_id]) ? htmlspecialchars(stripslashes($coupon_name[$language_id]), ENT_COMPAT, CHARSET, TRUE) : ''), zen_set_field_length(TABLE_COUPONS_DESCRIPTION, 'coupon_name') . ' id="coupon_name[' . $languages[$i]['id'] . ']" class="form-control"') ?>
                    <?php if ($i == 0) { ?>
                      <span class="input-group-addon">
                        <i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= COUPON_NAME_HELP ?>"></i>
                      </span>
                    <?php } ?>
                  </div>
                  <br>
            ...
            <div class="form-group">
            <?= zen_draw_label(COUPON_DESC, 'coupon_desc[' . $languages[0]['id'] . ']', 'class="control-label col-sm-3"') ?>
              <div class="col-sm-9 col-md-6">
                <?php
                for ($i = 0, $n = count($languages); $i < $n; $i++) {
                  $language_id = $languages[$i]['id'];
                  ...
                  <div class="input-group">
                    ...
                    <?= zen_draw_textarea_field('coupon_desc[' . $languages[$i]['id'] . ']', 'hard', '24', '8', (!empty($coupon_desc[$language_id]) ? htmlspecialchars(stripslashes($coupon_desc[$language_id]), ENT_COMPAT, CHARSET, TRUE) : ''), 'id="coupon_desc[' . $languages[$i]['id'] . ']" class="editorHook form-control"') ?>
                    <?php if ($i == 0) { ?>
                      <span class="input-group-addon">
                        <i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= COUPON_DESC_HELP ?>"></i>
                      </span>
                    <?php } ?>
                  </div>
                  <br>
            ...
            <div class="form-group">
              <?= zen_draw_label(COUPON_AMOUNT, 'coupon_amount', 'class="control-label col-sm-3"') ?>
              <div class="col-sm-9 col-md-6">
                <div class="input-group">
                  <?= zen_draw_input_field('coupon_amount', (!empty($coupon_amount) ? $coupon_amount : 0), 'class="form-control" id="coupon_amount"') ?>
                  <span class="input-group-addon">
                    <i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= COUPON_AMOUNT_HELP ?>"></i>
                  </span>
                </div>
              </div>
              <div class="col-sm-offset-3 col-sm-9 col-md-6">
                <label class="radio-inline"><?= zen_draw_radio_field('coupon_product_count', '0', (empty($coupon_product_count))) . TEXT_COUPON_PRODUCT_COUNT_PER_ORDER ?></label>
                <label class="radio-inline"><?= zen_draw_radio_field('coupon_product_count', '1', (!empty($coupon_product_count))) . TEXT_COUPON_PRODUCT_COUNT_PER_PRODUCT ?></label>
              </div>
            </div>
            <div class="form-group">
              <?= zen_draw_label(COUPON_MIN_ORDER, 'coupon_min_order', 'class="control-label col-sm-3"') ?>
              <div class="col-sm-9 col-md-6">
                <div class="input-group">
                  <?= zen_draw_input_field('coupon_min_order', (!empty($coupon_min_order) ? $coupon_min_order : 0), 'class="form-control" id="coupon_min_order"') ?>
                  <span class="input-group-addon">
                    <i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= COUPON_MIN_ORDER_HELP ?>"></i>
                  </span>
                </div>
              </div>
            </div>
            <div class="form-group">
              <p class="control-label col-sm-3"><?= COUPON_TOTAL ?></p>
              <div class="col-sm-9 col-md-6">
                <div class="radio">
                  <label><?= zen_draw_radio_field('coupon_calc_base', '0', (empty($coupon_calc_base))) . TEXT_COUPON_TOTAL_PRODUCTS . TEXT_COUPON_TOTAL_PRODUCTS_BASED ?></label>
                  <label><?= zen_draw_radio_field('coupon_calc_base', '1', (!empty($coupon_calc_base))) . TEXT_COUPON_TOTAL_ORDER . TEXT_COUPON_TOTAL_ORDER_BASED ?></label>
                  &nbsp;<i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= COUPON_TOTAL_HELP ?>"></i>
                </div>
              </div>
            </div>
            <div class="form-group">
              <?= zen_draw_label(COUPON_FREE_SHIP, 'coupon_free_ship', 'class="control-label col-sm-3"') ?>
              <div class="col-sm-9 col-md-6">
                <label><?= zen_draw_checkbox_field('coupon_free_ship', '', (!empty($coupon_free_ship)), '', 'id="coupon_free_ship"') ?></label>
                <i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= COUPON_FREE_SHIP_HELP ?>"></i>
              </div>
            </div>
            <div class="form-group">
              <p class="control-label col-sm-3"><?= COUPON_IS_VALID_FOR_SALES ?></p>
              <div class="col-sm-9 col-md-6">
                <div class="radio">
                  <label><?= zen_draw_radio_field('coupon_is_valid_for_sales', '1', (!empty($coupon_is_valid_for_sales))) . TEXT_COUPON_IS_VALID_FOR_SALES ?></label>
                  <label><?= zen_draw_radio_field('coupon_is_valid_for_sales', '0', (empty($coupon_is_valid_for_sales))) . TEXT_NO_COUPON_IS_VALID_FOR_SALES ?></label>
                  &nbsp;<i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= COUPON_SALE_HELP ?>"></i>
                </div>
              </div>
            </div>
            <div class="form-group">
              <?= zen_draw_label(COUPON_CODE, 'coupon_code', 'class="control-label col-sm-3"') ?>
              <div class="col-sm-9 col-md-6">
                <div class="input-group"><?= zen_draw_input_field('coupon_code', (!empty($coupon_code) ? htmlspecialchars($coupon_code, ENT_COMPAT, CHARSET, TRUE) : ''), 'class="form-control" id="coupon_code"') ?>
                  <span class="input-group-addon">
                    <i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= COUPON_CODE_HELP ?>"></i>
                  </span>
                </div>
              </div>
            </div>
            <div class="form-group">
              <?= zen_draw_label(COUPON_USES_COUPON, 'coupon_uses_coupon', 'class="control-label col-sm-3"') ?>
              <div class="col-sm-9 col-md-6">
                <div class="input-group"><?= zen_draw_input_field('coupon_uses_coupon', (!empty($coupon_uses_coupon) && $coupon_uses_coupon >= 1 ? $coupon_uses_coupon : ''), 'class="form-control" id="coupon_uses_coupon"') ?>
                  <span class="input-group-addon">
                    <i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= COUPON_USES_COUPON_HELP ?>"></i>
                  </span>
                </div>
              </div>
            </div>
            <div class="form-group">
              <?= zen_draw_label(COUPON_USES_USER, 'coupon_uses_user', 'class="control-label col-sm-3"') ?>
              <div class="col-sm-9 col-md-6">
                <div class="input-group"><?= zen_draw_input_field('coupon_uses_user', (!empty($coupon_uses_user) && $coupon_uses_user >= 1 ? $coupon_uses_user : ''), 'class="form-control" id="coupon_uses_user"') ?>
                  <span class="input-group-addon">
                    <i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= COUPON_USES_USER_HELP ?>"></i>
                  </span>
                </div>
              </div>
            </div>
            <div class="form-group">
              <?= zen_draw_label(COUPON_REFERRER . '&nbsp;<i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="' . COUPON_REFERRER_HELP . '"></i>', 'coupon_referrer', 'class="control-label col-sm-3"') ?>
              ...
              <div class="col-sm-12" data-list-entry>
                <div class="input-group"><?= zen_draw_input_field('coupon_referrer[]', $referrer, 'class="form-control"') ?>
                <div class="input-group-btn">
                  <button type="button" class="btn <?= $btn_cls ?>">
                    <i class="fa-solid <?= $btn_label ?>"></i>
                  </button>
                </div>
                </div>
              </div>
            ...
            ?>
            <div class="form-group">
              <p class="control-label col-sm-3"><?= COUPON_STARTDATE ?></p>
              <div class="col-sm-9 col-md-6">
                <div class="input-group"><?= zen_draw_date_selector('coupon_startdate', mktime(0, 0, 0, (int)$coupon_startdate[1], (int)$coupon_startdate[2], (int)$coupon_startdate[0])) ?>
                  <span class="input-group-addon">
                    <i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= COUPON_STARTDATE_HELP ?>"></i>
                  </span>
                </div>
              </div>
            </div>
            <div class="form-group">
              <p class="control-label col-sm-3"><?= COUPON_FINISHDATE ?></p>
              <div class="col-sm-9 col-md-6">
                <div class="input-group"><?= zen_draw_date_selector('coupon_finishdate', mktime(0, 0, 0, (int)$coupon_finishdate[1], (int)$coupon_finishdate[2], (int)$coupon_finishdate[0])) ?>
                  <span class="input-group-addon">
                    <i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= COUPON_FINISHDATE_HELP ?>"></i>
                  </span>
                </div>
              </div>
            </div>
            <div class="form-group">
              <?= zen_draw_label(COUPON_ZONE_RESTRICTION, 'coupon_zone_restriction', 'class="control-label col-sm-3"') ?>
              <div class="col-sm-9 col-md-6">
                <div class="input-group"><?= zen_geo_zones_pull_down_coupon('name="coupon_zone_restriction" class="form-control" id="coupon_zone_restriction"', (!empty($coupon_zone_restriction) ? $coupon_zone_restriction : 0)) ?>
                  <span class="input-group-addon">
                    <i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= TEXT_COUPON_ZONE_RESTRICTION ?>"></i>
                  </span>
                </div>
              </div>
            </div>
            <div class="form-group">
              <?= zen_draw_label(COUPON_ORDER_LIMIT, 'coupon_order_limit', 'class="control-label col-sm-3"') ?>
              <div class="col-sm-9 col-md-6">
                <div class="input-group"><?= zen_draw_input_field('coupon_order_limit', (!empty($coupon_order_limit) && $coupon_order_limit >= 1 ? $coupon_order_limit : ''), 'class="form-control" id="coupon_order_limit"') ?>
                  <span class="input-group-addon">
                    <i class="fa-solid fa-circle-info fa-lg" data-toggle="tooltip" title="<?= COUPON_ORDER_LIMIT_HELP ?>"></i>
                  </span>
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-9 col-md-6"><button type="submit" class="btn btn-primary"><?= COUPON_BUTTON_PREVIEW ?></button>&nbsp;<a href="<?= zen_href_link(FILENAME_COUPON_ADMIN, 'cid=' . $_GET['cid'] . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) ?>" class="btn btn-default" role="button"><?= IMAGE_CANCEL ?></a>
              </div>
            </div>
            <?php
                echo '</form>';
          ...
          default:
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <?= zen_draw_pull_down_menu('status', $status_array, $status, 'onChange="this.form.submit();" class="form-control" id="status"') ?>
                </div>
              </div>
              <?php
            ...
            <div class="col-sm-4">
              <?= zen_draw_form('set_editor_form', FILENAME_COUPON_ADMIN, '', 'get', 'class="form-horizontal"') ?>
              <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 configurationColumnLeft">
              <table class="table table-hover table-striped">
                <thead>
                  <tr class="dataTableHeadingRow">
                    <th class="dataTableHeadingContent"><?= COUPON_NAME ?></th>
                    <th class="dataTableHeadingContent text-center"><?= COUPON_AMOUNT ?></th>
                    <th class="dataTableHeadingContent text-center"><?= COUPON_CODE ?></th>
                    <th class="dataTableHeadingContent text-center"><?= COUPON_ACTIVE ?></th>
                    <th class="dataTableHeadingContent text-center"><?= COUPON_START_DATE ?></th>
                    <th class="dataTableHeadingContent text-center"><?= COUPON_EXPIRE_DATE ?></th>
                    <th class="dataTableHeadingContent text-center"><?= COUPON_RESTRICTIONS ?></th>
                    <th class="dataTableHeadingContent text-right"><?= TABLE_HEADING_ACTION ?></th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  foreach ($cc_list as $item) {
                    ...
                    if ((isset($cInfo)) && ($item['coupon_id'] == $cInfo->coupon_id)) {
                      ?>
                      <tr class="dataTableRowSelected" onclick="document.location.href = '<?= zen_href_link(FILENAME_COUPON_ADMIN, zen_get_all_get_params(['cid', 'action']) . 'cid=' . $cInfo->coupon_id . '&action=voucheredit') ?>'">
                      <?php } else { ?>
                      <tr class="dataTableRow" onclick="document.location.href = '<?= zen_href_link(FILENAME_COUPON_ADMIN, zen_get_all_get_params(['cid', 'action']) . 'cid=' . $item['coupon_id']) ?>'">
                        <?php
                      }
                      $coupon_desc = $db->Execute("SELECT coupon_name
                                                   FROM " . TABLE_COUPONS_DESCRIPTION . "
                      ...
                      ?>
                      <td class="dataTableContent"><?= $coupon_desc->fields['coupon_name'] ?></td>
                      ...
                      <td class="dataTableContent text-center"><?= $item['coupon_code'] ?></td>
                      <td class="dataTableContent text-center"><?= $item['coupon_active'] ?></td>
                      <td class="dataTableContent<?= (strtotime($item['coupon_start_date']) > time() ? ' coupon-future' : '') ?> text-center"><?= zen_date_short($item['coupon_start_date']) ?></td>
                      <td class="dataTableContent<?= (strtotime($item['coupon_expire_date']) < time() ? ' coupon-expired' : '') ?> text-center"><?= zen_date_short($item['coupon_expire_date']) ?></td>
                      <td class="dataTableContent text-center"><?= ($coupon_restrictions->RecordCount() > 0 ? '<a href="' . zen_href_link(FILENAME_COUPON_RESTRICT, 'cid=' . (int)$item['coupon_id'] . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '">' . 'Y' . '</a>' : 'N') ?></td>
                      <td class="dataTableContent text-right">
                        <?php
                        if ((isset($cInfo)) && ($item['coupon_id'] == $cInfo->coupon_id)) {
                          echo zen_icon('caret-right', '', '2x', true);
            ...
            switch ($_GET['action']) {
              case 'release':
                break;
              case 'voucherdelete':
                $heading[] = ['text' => '<h4>[' . $cInfo->coupon_id . ']  ' . $cInfo->coupon_code . ($cInfo->coupon_id == '' ? ' - (' . (!empty($_GET['cid']) ? $_GET['cid'] : 0) . ')' : '') . '</h4>'];
                $contents[] = ['text' => TEXT_CONFIRM_DELETE];
                $contents[] = [
                    'align' => 'text-center', 'text' => '<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'action=confirmdelete&cid=' . $_GET['cid'] . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-danger" role="button">' . TEXT_DISCOUNT_COUPON_CONFIRM_DELETE . '</a>&nbsp;<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'cid=' . $cInfo->coupon_id . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-default" role="button">' . IMAGE_CANCEL . '</a>'
                ];
                break;
              case 'voucherreactivate':
                $heading[] = ['text' => '<h4>[' . $cInfo->coupon_id . ']  ' . $cInfo->coupon_code . ($cInfo->coupon_id == '' ? ' - (' . (!empty($_GET['cid']) ? $_GET['cid'] : 0) . ')' : '') . '</h4>'];
                $contents[] = ['text' => TEXT_CONFIRM_REACTIVATE];
                $contents[] = [
                    'align' => 'text-center', 'text' => '<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'action=confirmreactivate&cid=' . $_GET['cid'] . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-primary" role="button">' . TEXT_DISCOUNT_COUPON_CONFIRM_RESTORE . '</a>&nbsp;<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'cid=' . $cInfo->coupon_id . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-default" role="button">' . IMAGE_CANCEL . '</a>'
                ];
                break;
              case 'vouchercopy':
                $heading[] = ['text' => '<h4>[' . $cInfo->coupon_id . ']  ' . $cInfo->coupon_code . ($cInfo->coupon_id == '' ? ' - (' . (!empty($_GET['cid']) ? $_GET['cid'] : 0) . ')' : '') . '</h4>'];
                $contents = ['form' => zen_draw_form('new_coupon', FILENAME_COUPON_ADMIN, 'action=confirmcopy' . '&cid=' . $_GET['cid'] . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : ''), 'post', 'enctype="multipart/form-data" class="form-horizontal"')];
                $contents[] = ['text' => zen_draw_label(TEXT_COUPON_NEW, 'coupon_copy_to', 'class="control-label"') . zen_draw_input_field('coupon_copy_to', '', 'class="form-control" id="coupon_copy_to"')];
                $contents[] = ['text' => TEXT_CONFIRM_COPY];
                $contents[] = ['align' => 'text-center', 'text' => '<button type="submit" class="btn btn-primary">' . IMAGE_SAVE . '</button>&nbsp;<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'cid=' . $cInfo->coupon_id . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-default" role="button">' . IMAGE_CANCEL . '</a>'];
                break;
              case 'voucherduplicate':
                $heading[] = ['text' => '<h4>[' . $cInfo->coupon_id . ']  ' . $cInfo->coupon_code . ($cInfo->coupon_id == '' ? ' - (' . (!empty($_GET['cid']) ? $_GET['cid'] : 0) . ')' : '') . '</h4>'];
                $contents = ['form' => zen_draw_form('duplicate_coupon', FILENAME_COUPON_ADMIN, 'action=confirmcopyduplicate' . '&cid=' . $_GET['cid'] . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : ''), 'post', 'enctype="multipart/form-data" class="form-horizontal"')];
                $contents[] = ['text' => TEXT_COUPON_COPY_INFO];
                $contents[] = ['text' => zen_draw_label(TEXT_COUPON_COPY_DUPLICATE, 'coupon_copy_to_dup_name', 'class="control-label"') . zen_draw_input_field('coupon_copy_to_dup_name', $cInfo->coupon_code, 'class="form-control" id="coupon_copy_to_dup_name"')];
                $contents[] = ['text' => zen_draw_label(TEXT_COUPON_COPY_DUPLICATE_CNT, 'coupon_copy_to_count', 'class="control-label"') . zen_draw_input_field('coupon_copy_to_count', '', 'class="form-control" id="coupon_copy_to_count"')];
                $contents[] = ['text' => TEXT_CONFIRM_COPY];
                $contents[] = ['align' => 'text-center', 'text' => '<button type="submit" class="btn btn-primary">' . IMAGE_SAVE . '</button>&nbsp;<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'cid=' . $cInfo->coupon_id . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-default" role="button">' . IMAGE_CANCEL . '</a>'];
                break;
              case 'voucherduplicatedelete':
                $chk_duplicate_delete = $db->Execute("SELECT *
                                                      ...
                                                      WHERE coupon_id = " . (int)$_GET['cid']);
                $heading[] = ['text' => '<h4>[' . $cInfo->coupon_id . ']  ' . $cInfo->coupon_code . ($cInfo->coupon_id == '' ? ' - (' . (!empty($_GET['cid']) ? $_GET['cid'] : 0) . ')' : '') . '</h4>'];
                $contents = ['form' => zen_draw_form('duplicate_coupon_delete', FILENAME_COUPON_ADMIN, 'action=confirmdeleteduplicate' . '&cid=' . $_GET['cid'] . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : ''), 'post', 'enctype="multipart/form-data" class="form-horizontal"')];

                $contents[] = ['text' => sprintf(TEXT_CONFIRM_DELETE_DUPLICATE, $chk_duplicate_delete->fields['coupon_code'], $chk_duplicate_delete->fields['coupon_code'])];
                $contents[] = ['text' => zen_draw_label(TEXT_COUPON_DELETE_DUPLICATE, 'coupon_delete_duplicate_code', 'class="control-label"') . zen_draw_input_field('coupon_delete_duplicate_code', $chk_duplicate_delete->fields['coupon_code'], 'class="form-control" id="coupon_copy_to_count"')];
                $contents[] = ['align' => 'text-center', 'text' => '<button type="submit" class="btn btn-danger">' . TEXT_DISCOUNT_COUPON_CONFIRM_DELETE . '</button>&nbsp;<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'cid=' . $cInfo->coupon_id . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-default" role="button">' . IMAGE_CANCEL . '</a>'];
                break;
              default:
                if ($cc_list->RecordCount() > 0) {
                  $heading[] = ['text' => '<h4>[' . $cInfo->coupon_id . ']  ' . $cInfo->coupon_code . ($cInfo->coupon_id == '' ? ' - (' . (!empty($_GET['cid']) ? $_GET['cid'] : 0) . ')' : '') . '</h4>'];
                } else {
                  $heading[] = ['text' => '<h4>' . ERROR_NO_COUPONS . '</h4>'];
                }
                ...
                if ($cInfo->coupon_id != '') {
                  $contents[] = ['text' => COUPON_NAME . ':&nbsp;' . $coupon_name->fields['coupon_name']];
                  $contents[] = ['text' => COUPON_AMOUNT . ':&nbsp;' . $amount . ' ' . ($cInfo->coupon_product_count == 0 ? TEXT_COUPON_PRODUCT_COUNT_PER_ORDER : TEXT_COUPON_PRODUCT_COUNT_PER_PRODUCT) . '<br>' . ($coupon_name->fields['coupon_type'] == 'E' || $coupon_name->fields['coupon_type'] == '0' ? TEXT_FREE_SHIPPING : '')];
                  $contents[] = ['text' => COUPON_STARTDATE . ':&nbsp;' . zen_date_short($cInfo->coupon_start_date)];
                  $contents[] = ['text' => COUPON_FINISHDATE . ':&nbsp;' . zen_date_short($cInfo->coupon_expire_date)];
                  $contents[] = ['text' => COUPON_USES_COUPON . ':&nbsp;' . $uses_coupon];
                  $contents[] = ['text' => COUPON_USES_USER . ':&nbsp;' . $uses_user];
                  $contents[] = ['text' => COUPON_REFERRER . ':&nbsp;' . ($cInfo->referrer ?? 'none')];
                  $contents[] = ['text' => COUPON_PRODUCTS . ':&nbsp;' . $prod_details];
                  $contents[] = ['text' => COUPON_CATEGORIES . ':&nbsp;' . $cat_details];
                  $contents[] = ['text' => COUPON_MIN_ORDER . ':&nbsp;' . $currencies->format($cInfo->coupon_minimum_order)];
                  $contents[] = ['text' => COUPON_TOTAL . ':&nbsp;' . ($cInfo->coupon_calc_base == 0 ? TEXT_COUPON_TOTAL_PRODUCTS : TEXT_COUPON_TOTAL_ORDER)];
                  $contents[] = ['text' => DATE_CREATED . ':&nbsp;' . zen_date_short($cInfo->date_created)];
                  $contents[] = ['text' => DATE_MODIFIED . ':&nbsp;' . zen_date_short($cInfo->date_modified)];
                  $contents[] = ['text' => COUPON_ZONE_RESTRICTION . ':&nbsp;' . zen_get_geo_zone_name($cInfo->coupon_zone_restriction)];
                  $contents[] = ['text' => COUPON_ORDER_LIMIT . ':&nbsp;' . ($coupon_order_limit > 0 ? $coupon_order_limit : TEXT_UNLIMITED)];
                  $contents[] = ['text' => COUPON_IS_VALID_FOR_SALES . ':&nbsp;' . ($coupon_is_valid_for_sales == 1 ? TEXT_COUPON_IS_VALID_FOR_SALES : TEXT_NO_COUPON_IS_VALID_FOR_SALES)];
                  $contents[] = [
                      'align' => 'text-center', 'text' => ($cInfo->coupon_active != 'N' ? '<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'action=email&cid=' . $cInfo->coupon_id) . '" class="btn btn-primary" role="button">' . TEXT_DISCOUNT_COUPON_EMAIL . '</a>' : '') . '&nbsp;<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'action=voucheredit&cid=' . $cInfo->coupon_id . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-primary" role="button">' . TEXT_DISCOUNT_COUPON_EDIT . '</a>' . ($cInfo->coupon_active != 'N' ? '&nbsp;<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'action=voucherdelete&cid=' . $cInfo->coupon_id . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-warning" role="button">' . TEXT_DISCOUNT_COUPON_DELETE . '</a>' : '&nbsp;<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'action=voucherreactivate&cid=' . $cInfo->coupon_id . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-primary" role="button">' . TEXT_DISCOUNT_COUPON_RESTORE . '</a>')
                  ];
                  $contents[] = ['align' => 'text-center', 'text' => '<a href="' . zen_href_link(FILENAME_COUPON_RESTRICT, 'cid=' . $cInfo->coupon_id . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-primary" role="button">' . TEXT_DISCOUNT_COUPON_RESTRICT . '</a>&nbsp;<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'action=voucherreport&cid=' . $cInfo->coupon_id . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (!empty($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-primary" role="button">' . TEXT_DISCOUNT_COUPON_REPORT . '</a>&nbsp;<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'action=vouchercopy&cid=' . $cInfo->coupon_id) . '" class="btn btn-primary" role="button">' . TEXT_DISCOUNT_COUPON_COPY . '</a>'];
                  $contents[] = ['align' => 'text-center', 'text' => zen_draw_separator('pixel_black.gif', '100%', '2') . '<br><br>' . sprintf(TEXT_INFO_DUPLICATE_MANAGEMENT, $cInfo->coupon_code)];
                  $contents[] = ['align' => 'text-center', 'text' => ($cInfo->coupon_active != 'N' ? '<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'action=voucherduplicate&cid=' . $cInfo->coupon_id . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-primary" role="button">' . TEXT_DISCOUNT_COUPON_COPY_MULTIPLE . '</a>' : '') . ($cInfo->coupon_active != 'N' ? '&nbsp;<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'action=voucherduplicatedelete&cid=' . $cInfo->coupon_id . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-warning" role="button">' . TEXT_DISCOUNT_COUPON_DELETE_MULTIPLE . '</a>' : '')];
                  $contents[] = ['align' => 'text-center', 'text' => '<a href="' . zen_href_link(FILENAME_COUPON_ADMIN, 'action=voucherreportduplicates&cid=' . $cInfo->coupon_id . '&codebase=' . $cInfo->coupon_code . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-primary" role="button">' . TEXT_DISCOUNT_COUPON_REPORT_MULTIPLE . '</a>&nbsp;<a href="' . zen_href_link(FILENAME_COUPON_ADMIN_EXPORT, 'cid=' . $cInfo->coupon_id . '&codebase=' . $cInfo->coupon_code . (isset($_GET['status']) ? '&status=' . $_GET['status'] : '') . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '" class="btn btn-primary" role="button">' . TEXT_DISCOUNT_COUPON_DOWNLOAD . '</a>'];
                }
                break;
            }
            ?>
