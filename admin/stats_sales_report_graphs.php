...
$startDate = "";
if (isset($_GET['startDate']) && $_GET['startDate'] && zen_not_null($_GET['startDate']) && $_GET['startDate'] >= '0001-01-01') {
  $startDate = $_GET['startDate'];
}
$endDate = "";
if (isset($_GET['endDate']) && $_GET['endDate'] && zen_not_null($_GET['endDate']) && $_GET['endDate'] >= '0001-01-01') {
