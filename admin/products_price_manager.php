    ...
    case ('update'):
      ...
      $sql = "UPDATE " . TABLE_PRODUCTS . "
              SET products_price = " . (float)$_POST['products_price'] . ",
                  ...
                  products_quantity_order_min = " . (int)$_POST['products_quantity_order_min'] . ",
                  products_quantity_order_units = " . (int)$_POST['products_quantity_order_units'] . ",
                  products_quantity_order_max = " . (int)$_POST['products_quantity_order_max'] . ",
