      ...
      if ($action == 'new') {
        ...
        <div class="row">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9 col-md-6">
              <?= zen_draw_pull_down_menu('banners_group', $groups_array, $bInfo->banners_group, 'class="form-control" id="banners_group"') ?><br>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9 col-md-6">
              ...
              <p><?= TEXT_BANNERS_IMAGE_LOCAL ?></p>
              <p><?= DIR_FS_CATALOG_IMAGES ?></p>
              <?= zen_draw_input_field('banners_image_local', ($bInfo->banners_image ?? ''), zen_set_field_length(TABLE_BANNERS, 'banners_image') . ' class="form-control"') ?>
            </div>
          </div>
          <div class="form-group">
            <?= zen_draw_label(TEXT_BANNERS_IMAGE_TARGET, 'banners_image_target', 'class="col-sm-3 control-label"') ?>
            <div class="col-sm-9 col-md-6">
              <?= zen_draw_input_field('banners_image_target', '', 'class="form-control" id="banners_image_target"') ?>
              <span class="help-block"><?= DIR_FS_CATALOG_IMAGES ?></span>
              <div>
