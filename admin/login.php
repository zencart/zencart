...
?>
    ...
    <?php if (!isset($expired) || $expired == FALSE) { ?>
        ...
        <form id="loginForm" name="loginForm"
              action="<?php echo zen_href_link(FILENAME_LOGIN, zen_get_all_get_params(), 'SSL'); ?>" method="post"
              onsubmit="animate(this)">
            <div id="loginFormDiv" class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                <fieldset>
                    ...
                    <input type="text" id="admin_name" name="admin_name"
                           value="<?php echo zen_output_string($admin_name); ?>" autocomplete="off"/>
                    <br class="clearBoth"/>
                    ...
                    <input type="hidden" name="action" value="do<?php echo $_SESSION['securityToken']; ?>"
                           id="action1"/>
    ...
    <?php } else { ?>
        ...
        <form id="loginForm" name="loginForm" action="<?php echo zen_href_link(FILENAME_LOGIN, '', 'SSL'); ?>"
              method="post"
              onsubmit="animate(this)">
            <div id="loginFormDiv" class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="text-align: right;">
                            ...
                            <label class="loginLabel" for="confpwd"
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="text-align: left">
                            ...
                            <input type="password" id="old_pwd"
                                   name="oldpwd-<?php echo $_SESSION['securityToken']; ?>" autocomplete="off"/>
                            <input type="password" id="admin_pass"
                                   name="newpwd-<?php echo $_SESSION['securityToken']; ?>" autocomplete="off"/>
                            <input type="password" id="admin_pass2"
                                   name="confpwd-<?php echo $_SESSION['securityToken']; ?>" autocomplete="off"/>
                        </div>
                        <br class="clearBoth"/>
                        <input type="hidden" name="securityToken" value="<?php echo $_SESSION['securityToken']; ?>">
                        <input type="submit" name="submit" class="button" value="Submit" id="btn_submit"/>
                        <input type="hidden" name="action" value="rs<?php echo $_SESSION['securityToken']; ?>"
                               id="action1"/>
                        <img id="actionImg" src="images/loading.gif" class="hiddenField"/>
                    </div>
                </fieldset>
