  ...
  <body class="indexDashboard" onLoad="init()">
    ...
    <div id="colone" class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
      ...
      <div class="panel panel-default reportBox">
        ...
        <table class="table table-striped table-condensed">
            <?php
            $orders_status = $db->Execute("SELECT orders_status_name, orders_status_id, sort_order FROM " . TABLE_ORDERS_STATUS . " WHERE language_id = " . (int)$_SESSION['languages_id'] . " ORDER BY sort_order ASC, orders_status_id ASC", false, true, 3600);
