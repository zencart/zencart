...
//              visibleInLegend: true
    ...
    <style>
        #colone, #coltwo, #colthree { padding: 15px; }
        #colone { width: 24%; }
        #coltwo { width: 31%; }
        #colthree { width: 44%; }
        ...
        /*#div.row span.left {float: left;text-align: left;width: 50%;white-space: nowrap;}*/
        #div.row span.center { margin-right: 30px; }
        .reportBox div.row span.right { float: right; text-align: right; white-space: nowrap; width: auto; }
        .indented { padding-left: 5%; margin-right: 5%;}
        /*
        div.reportBox { background: dodgerblue;}
        ul.nde-menu-system { background-color: #6666FF;}
        .headerBar { background-color: navy;}
        */
...
<div id="colone" class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
    <div class="reportBox">
        ...
        if (REVIEWS_APPROVAL == '1') {
            echo '<div class="row"><span class="left"><a href="' . zen_href_link(FILENAME_REVIEWS,
                    'status=1') . '">' . BOX_ENTRY_REVIEWS_PENDING . '</a></span><span class="right">' . $reviews_pending->fields['count'] . '</span></div>';
        }
    ...
    <div class="reportBox">
        ...
        <?php
        echo '<div class="row"><span class="left">' . BOX_ENTRY_SPECIALS_EXPIRED . '</span><span class="right"> ' . $specials->fields['count'] . '</span></div>';
    ...
    <div class="reportBox">
        ...
        foreach ($orders_status as $row) {
            ...
            ?>
            <div class="row"><span class="left"><a href="<?php echo zen_href_link(FILENAME_ORDERS, 'selected_box=customers&status=' . $row['orders_status_id']); ?>"><?php echo $row['orders_status_name']; ?></a>:</span>
...
<div id="coltwo" class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
    <div class="reportBox">
        ...
        $customers = $db->Execute(
                "select c.customers_id as customers_id, c.customers_firstname as customers_firstname, 
    ...
    <?php if (count($visit_history)) { ?>
        ...
        ?>
            <div class="row">
                <span class="left indented"><?php echo $row['date'];?></span>
...
<div id="colthree" class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
    <div class="reportBox">
        ...
        <?php
        $orders = $db->Execute(
                "select o.orders_id as orders_id, o.customers_name as customers_name, o.customers_id, 
            ...
            <div class="row">
                <span class="left">
                    <a href="<?php echo zen_href_link(FILENAME_ORDERS, 'oID=' . $order['orders_id'] . '&origin=' . FILENAME_DEFAULT); ?>" class="contentlink">
                        <?php echo substr($order['customers_name'], 0, 20); ?>
                    </a>
                </span>
                <span class="center"><?php echo $amt; ?></span>
                <span class="right"><?php echo zen_date_short($order['date_purchased']); ?></span></div>
        <?php } ?>
    </div>
    ...
    <div class="reportBox">
        ...
        <div id="graph2"></div>
        <div class="row">
            <span class="left"><?php echo sprintf(TEXT_SALES_TODAY, $dsc, number_format($ds, 2)); ?></span> &nbsp;
