...
<html <?php echo HTML_PARAMS; ?>>
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <table class="table">
        <tr>
          <td><?php echo $artists_split->display_count($artists_query_numrows, zen_config('MAX_DISPLAY_SEARCH_RESULTS'), $_GET['page'], TEXT_DISPLAY_NUMBER_OF_ARTISTS); ?></td>
          <td class="text-right"><?php echo $artists_split->display_links($artists_query_numrows, zen_config('MAX_DISPLAY_SEARCH_RESULTS'), zen_config('MAX_DISPLAY_PAGE_LINKS'), $_GET['page']); ?></td>
        </tr>
        <?php if (empty($action)) { ?>
          <tr>
