      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo zen_draw_form('update_all_products_attributes_sort_order', FILENAME_STORE_MANAGER, 'action=update_all_products_attributes_sort_order')?><input type="hidden" name="confirm" value="yes" /><input class="btn btn-default btn-sm" type="submit" value="Update"></form></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo zen_draw_form('update_all_products_price_sorter', FILENAME_STORE_MANAGER, 'action=update_all_products_price_sorter')?><input type="hidden" name="confirm" value="yes" /><input class="btn btn-default btn-sm" type="submit" value="Update"></form></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          ...
          <?php echo zen_draw_hidden_field('securityToken', $_SESSION['securityToken']); ?>
            ...
            <td class="main" align="right" valign="middle"><input class="btn btn-default btn-sm" type="submit" value="Update"></td>
          </form></tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo zen_draw_form('update_all_products_viewed', FILENAME_STORE_MANAGER, 'action=update_all_products_viewed')?><input type="hidden" name="confirm" value="yes" /><input class="btn btn-default btn-sm" type="submit" value="Reset"></form></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo zen_draw_form('update_all_products_ordered', FILENAME_STORE_MANAGER, 'action=update_all_products_ordered')?><input type="hidden" name="confirm" value="yes" /><input class="btn btn-default btn-sm" type="submit" value="Reset"></form></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo zen_draw_form('update_all_master_categories_id', FILENAME_STORE_MANAGER, 'action=update_all_master_categories_id')?><input type="hidden" name="confirm" value="yes" /><input class="btn btn-default btn-sm" type="submit" value="Reset"></form></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          ...
          <?php echo zen_draw_hidden_field('securityToken', $_SESSION['securityToken']); ?>
            ...
            <input class="btn btn-default btn-sm" type="submit" value="Update"></td>
            </form>
          </tr>
        </table>
        </td>
      ...
      <tr>
        <td colspan="2"><br /><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo zen_draw_form('optimize_db_start', FILENAME_STORE_MANAGER, 'action=optimize_db_start')?><input type="hidden" name="confirm" value="yes" /><input class="btn btn-default btn-sm" type="submit" value="Reset"></form></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><br /><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo zen_draw_form('clean_debug_files', FILENAME_STORE_MANAGER, 'action=clean_debug_files', 'post') . '<input class="btn btn-default btn-sm" type="submit" value="Confirm"></form>'; ?>
          </tr>
        </table></td>
      </tr>
