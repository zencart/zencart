...
<?php
  ...
  switch ($action) {
    ...
    case 'edit':
      ...
      $contents[] = array('text' => '<br />' . TEXT_MEDIA_COLLECTION_NAME . '<br>' . zen_draw_input_field('media_name', htmlspecialchars($mInfo->media_name, ENT_COMPAT, CHARSET, FALSE), zen_set_field_length(TABLE_MEDIA_MANAGER, 'media_name')));
