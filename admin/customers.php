      ...
      if ($action == 'edit' || $action == 'update') {
        ...
        <?php
          ...
          <?php }
            ...
            // additional fields are specified as a simple array of arrays, with each array element identifying
            // a new input element:
            //
            // $additional_fields = array(
            //      array(
            //          'label' => 'The text to include for the field label',
            //            'for' => 'The ID of the input field',
          ...
          if (count($additional_fields) > 0) { ?>
              ...
              <div class="row formAreaTitle"><?php echo TEXT_CUSTOM_FIELDS; ?></div>
              <div class="formArea">
                  <?php foreach ($additional_fields as $current_field) {
                      ?>
                      <div class="form-group">
                          <?php echo zen_draw_label($current_field['label'], $current_field['for'], 'class="col-sm-3 control-label"'); ?>
