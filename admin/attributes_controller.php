 ...
 * @version $Id: DrByte 2021 Jan 11 Modified in v1.5.8 $
 */
...
// end modification for sort order
          ...
          $attributes_price_factor = (float)$_POST['attributes_price_factor'] ?? 0;
          $attributes_price_factor_offset = (float)$_POST['attributes_price_factor_offset'] ?? 0;
          $attributes_price_factor_onetime = (float)$_POST['attributes_price_factor_onetime'] ?? 0;
          $attributes_price_factor_onetime_offset = (float)$_POST['attributes_price_factor_onetime_offset'] ?? 0;
          ...
          $attributes_price_words = (float)$_POST['attributes_price_words'] ?? 0;
          $attributes_price_words_free = (int)$_POST['attributes_price_words_free'] ?? 0;
          $attributes_price_letters = (float)$_POST['attributes_price_letters'] ?? 0;
          $attributes_price_letters_free = (int)$_POST['attributes_price_letters_free'] ?? 0;
