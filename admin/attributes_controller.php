                ...
                <table width="100%" cellspacing="0" cellpadding="0">
                  ...
                  if ($action == 'attributes_preview') {
                    ...
                    if ($products_filter != '' and $action != 'attribute_features_copy_to_product' and $action != 'attribute_features_copy_to_category' and $action != 'delete_all_attributes_confirm') {
                      ...
                      <tr>
                        <td>
                          <table border="1" cellspacing="2" cellpadding="4" align="left">
                            <tr>
                            ...
                            <tr>
                              ...
                              if (zen_has_product_attributes($products_filter, 'false')) {
                                ...
                                ?>
                                <td class="main" align="center" colspan="5"><?php echo TEXT_NO_ATTRIBUTES_DEFINED . $products_filter; ?></td>
                                <?php
                              }
                              ?>
                            </tr>
...
// remove option name and all values from the product
                  if ($action == 'delete_option_name_values_confirm') {
                    ...
                    <tr>
                      <td>
                        <form name="delete_all"<?php echo 'action="' . zen_href_link(FILENAME_ATTRIBUTES_CONTROLLER, 'action=delete_option_name_values') . '"'; ?> method="post"><?php echo zen_draw_hidden_field('securityToken', $_SESSION['securityToken']); ?>
                  ...
                  ?>
                  <tr>
                    <td class="main" height="20" align="center"><?php echo zen_draw_separator('pixel_black.gif', '90%', '2'); ?></td>
                  </tr>
                  <?php
                  if ($action == '') {
                    ?>
...
// start of attributes display
                  if ($_GET['products_filter'] == '') {
                    ?>
                    <tr>
                      <td class="pageHeading" align="center" valign="middle" height="200"><?php echo HEADING_TITLE_ATRIB_SELECT; ?></td>
                    </tr>
                    <?php
                  } else {
////
...
// delete all option name values
                              ...
                              if (($action == 'update_attribute') && ($_GET['attribute_id'] == $attributes_values->fields['products_attributes_id'])) {
                                ...
                                <tr>
                                  <td colspan="10" class="attributeBoxContent">
                                    <table width="100%">
                                      <tr>
...
// set image delete
                                      ...
                                      <tr>
                                        <td>
                                          <table>
                                            <tr>
                                              <td class="pageHeading"><?php echo TEXT_PRICES_AND_WEIGHTS; ?></td>
                                            </tr>
                                            <tr>
                                              <td class="attributeBoxContent">
...
// attributes images
                              ...
                              where products_attributes_id='" . $attributes_values->fields['products_attributes_id'] . "'";
                                ...
                                <tr class="attributeBoxContent">
                                  ...
                                  <td colspan="4" align="center" class="attributeBoxContent">&nbsp;</td>
                                </tr>
                                <tr>
                                  ...
                                  <td colspan="3" align="center" class="attributeBoxContent">&nbsp;<b><?php echo zen_image_submit('button_confirm.gif', IMAGE_CONFIRM); ?>&nbsp;&nbsp;<a href="<?php echo zen_href_link(FILENAME_ATTRIBUTES_CONTROLLER, (isset($_GET['option_page']) ? '&option_page=' . $_GET['option_page'] . '&' : '') . (isset($_GET['value_page']) ? '&value_page=' . $_GET['value_page'] . '&' : '') . (isset($_GET['attribute_page']) ? '&attribute_page=' . $_GET['attribute_page'] : '') . '&products_filter=' . $products_filter . '&current_category_id=' . $current_category_id); ?>"><?php echo zen_image_button('button_cancel.gif', IMAGE_CANCEL); ?></a>&nbsp;</b></td>
