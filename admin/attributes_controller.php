...
$chk_option_names = $db->Execute("SELECT products_options_id FROM " . TABLE_PRODUCTS_OPTIONS . " WHERE language_id = '" . (int)$_SESSION['languages_id'] . "' LIMIT 1");
...
$ary = array();
$chk_option_values = $db->Execute("SELECT DISTINCT language_id FROM " . TABLE_PRODUCTS_OPTIONS_VALUES . " WHERE products_options_values_id = " . (int)PRODUCTS_OPTIONS_VALUES_TEXT_ID);
...
// delete all attributes
    ...
    case 'delete_option_name_values':
      ...
      $delete_attributes_options_id = $db->Execute("SELECT products_attributes_id
                                                    FROM " . TABLE_PRODUCTS_ATTRIBUTES . "
                                                    WHERE products_id = '" . $_POST['products_filter'] . "'
                                                    AND options_id = '" . $_POST['products_options_id_all'] . "'");
      foreach ($delete_attributes_options_id as $attributes_options_id) {
// remove any attached downloads
        $db->Execute("DELETE FROM " . TABLE_PRODUCTS_ATTRIBUTES_DOWNLOAD . " WHERE products_attributes_id = '" . $attributes_options_id['products_attributes_id'] . "'");
// remove all option values
        $db->Execute("DELETE FROM " . TABLE_PRODUCTS_ATTRIBUTES . " WHERE products_id = '" . $_POST['products_filter'] . "' AND options_id = '" . $_POST['products_options_id_all'] . "'");
      }
...
// show reset search
          ...
          <div>
            ...
            <div class="form-group" style="height:40px">
              <a href="<?php echo zen_href_link(FILENAME_OPTIONS_NAME_MANAGER) ?>"><?php echo zen_image_button('button_option_names.gif', IMAGE_OPTION_NAMES); ?></a>
              <a href="<?php echo zen_href_link(FILENAME_OPTIONS_VALUES_MANAGER) ?>"><?php echo zen_image_button('button_option_values.gif', IMAGE_OPTION_VALUES); ?></a>
            </div>
            <div>
              <h1>&nbsp;<?php echo HEADING_TITLE_ATRIB; ?>&nbsp;</h1>
            </div>
            <?php
            // show the attributes
            if ($products_filter != '' && $action != 'attribute_features_copy_to_product' && $action != 'attribute_features_copy_to_category' && $action != 'delete_all_attributes_confirm') {
              ?>
              ...
              <div class="table-responsive">
                <table class="table-bordered">
                  <tr>
                    <td colspan="7" class="main text-center">
                  ...
                  <tr>
                    <td class="smallText text-center"><?php echo '<a href="' . zen_href_link(FILENAME_CATEGORIES, 'action=new_product' . '&cPath=' . zen_get_product_path($products_filter) . '&pID=' . $products_filter . '&product_type=' . zen_get_products_type($products_filter)) . '">' . zen_image_button('button_edit_product.gif', IMAGE_EDIT_PRODUCT) . '<br />' . TEXT_PRODUCT_EDIT . '</a>'; ?></td>
                    ...
                    if (zen_has_product_attributes($products_filter, 'false')) {
                      ?>
                      <td class="smallText text-center"><?php echo zen_draw_form('update_sort', FILENAME_ATTRIBUTES_CONTROLLER, 'action=update_attribute_sort' . '&products_filter=' . $products_filter . '&current_category_id=' . $current_category_id); ?><?php echo zen_image_submit('button_update_sort.gif', IMAGE_UPDATE_SORT); ?><?php echo zen_draw_hidden_field('confirm', 'y'); ?><?php echo '</form>'; ?><br /><?php echo TEXT_ATTRIBUTES_UPDATE_SORT_ORDER; ?></td>
                      <td class="smallText text-center"><?php echo '<a href="' . zen_href_link(FILENAME_ATTRIBUTES_CONTROLLER, '&action=delete_all_attributes_confirm' . '&products_filter=' . $products_filter . '&current_category_id=' . $current_category_id) . '">' . zen_image_button('button_delete.gif', IMAGE_DELETE) . '<br />' . TEXT_ATTRIBUTES_DELETE . '</a>'; ?></td>
                      <td class="smallText text-center"><?php echo '<a href="' . zen_href_link(FILENAME_ATTRIBUTES_CONTROLLER, '&action=attribute_features_copy_to_product' . '&products_filter=' . $products_filter . '&current_category_id=' . $current_category_id) . '">' . zen_image_button('button_copy_to.gif', IMAGE_COPY) . '<br />' . TEXT_ATTRIBUTES_COPY_TO_PRODUCTS . '</a>'; ?></td>
                      <td class="smallText text-center"><?php echo '<a href="' . zen_href_link(FILENAME_ATTRIBUTES_CONTROLLER, '&action=attribute_features_copy_to_category' . '&products_filter=' . $products_filter . '&current_category_id=' . $current_category_id) . '">' . zen_image_button('button_copy_to.gif', IMAGE_COPY) . '<br />' . TEXT_ATTRIBUTES_COPY_TO_CATEGORY . '</a>'; ?></td>
                      <?php
                    } else {
                      ?>
                      <td class="main text-center" colspan="4"><?php echo TEXT_NO_ATTRIBUTES_DEFINED . $products_filter; ?></td>
                      <?php
                    }
                    ?>
                  </tr>
                  <tr>
                    <td class="smallText text-center" colspan="7"><?php echo '<a href="' . zen_href_link(FILENAME_PRODUCTS_TO_CATEGORIES, '&products_filter=' . $products_filter . '&current_category_id=' . $current_category_id) . '">' . IMAGE_PRODUCTS_TO_CATEGORIES . '</a>'; ?></td>
                  </tr>
                </table>
              </div>
              <div><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></div>
...
// remove all attributes from the product
            if ($action == 'delete_all_attributes_confirm') {
              ...
              <div class="table-responsive">
                ...
                <table>
                  <tr>
                    <td class="alert text-center"><?php echo TEXT_DELETE_ALL_ATTRIBUTES . $products_filter . '<br />' . zen_get_products_name($products_filter); ?></td>
                    <td class="main text-center"><?php echo zen_image_submit('button_delete.gif', IMAGE_DELETE) . '&nbsp;&nbsp;' . '<a href="' . zen_href_link(FILENAME_ATTRIBUTES_CONTROLLER, 'products_filter=' . $products_filter . '&current_category_id=' . $current_category_id . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '">' . zen_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>'; ?></td>
                  </tr>
                </table>
                <?php echo '</form>'; ?>
              </div>
...
// remove option name and all values from the product
              ...
              <div>
                ...
                <table>
                  <tr class="pageHeading">
                    <td class="alert text-center" colspan="2"><?php echo TEXT_DELETE_ATTRIBUTES_OPTION_NAME_VALUES; ?></td>
                  </tr>
                  <tr>
                    <td class="main"><?php echo TEXT_INFO_PRODUCT_NAME . zen_get_products_name($products_filter) . '<br />' . TEXT_INFO_PRODUCTS_OPTION_ID . $_GET['products_options_id_all'] . '&nbsp;' . TEXT_INFO_PRODUCTS_OPTION_NAME . '&nbsp;' . zen_options_name($_GET['products_options_id_all']); ?></td>
                    <td class="main"><?php echo zen_image_submit('button_delete.gif', IMAGE_DELETE) . '&nbsp;&nbsp;' . '<a href="' . zen_href_link(FILENAME_ATTRIBUTES_CONTROLLER, 'products_filter=' . $products_filter . '&current_category_id=' . $current_category_id . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '">' . zen_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>'; ?></td>
                  </tr>
                </table>
                <?php echo '</form>'; ?>
              </div>
            ...
            if ($action == 'attribute_features_copy_to_product') {
              ...
              ?>
              <div>
                <?php echo zen_draw_form('product_copy_to_product', FILENAME_ATTRIBUTES_CONTROLLER, 'action=update_attributes_copy_to_product'); ?>
                <?php echo zen_draw_hidden_field('products_filter', $_GET['products_filter']); ?>
                ...
                <table>
                  <tr>
                    <td class="main text-center"><?php echo TEXT_INFO_ATTRIBUTES_FEATURES_COPY_TO_PRODUCT . $products_filter . '<br />' . zen_get_products_name($products_filter); ?></td>
                    <td class="main"><?php echo TEXT_COPY_ATTRIBUTES_CONDITIONS . '<br />' . zen_draw_radio_field('copy_attributes', 'copy_attributes_delete', true) . ' ' . TEXT_COPY_ATTRIBUTES_DELETE . '<br />' . zen_draw_radio_field('copy_attributes', 'copy_attributes_update') . ' ' . TEXT_COPY_ATTRIBUTES_UPDATE . '<br />' . zen_draw_radio_field('copy_attributes', 'copy_attributes_ignore') . ' ' . TEXT_COPY_ATTRIBUTES_IGNORE; ?></td>
                  </tr>
                  <tr>
                    <td class="alert text-center"><?php echo TEXT_INFO_ATTRIBUTES_FEATURE_COPY_TO . '<br />' . zen_draw_products_pull_down('products_update_id', 'size="15"', $products_exclude_array, true, '', true); ?></td>
                    <td class="main text-center"><?php echo zen_image_submit('button_copy.gif', IMAGE_COPY) . '&nbsp;&nbsp;' . '<a href="' . zen_href_link(FILENAME_ATTRIBUTES_CONTROLLER, 'products_filter=' . $products_filter . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '">' . zen_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>'; ?></td>
                  </tr>
                </table>
                <?php echo '</form>'; ?>
              </div>
            ...
            if ($action == 'attribute_features_copy_to_category') {
              ?>
              <div class="table-responsive">
                <?php zen_draw_form('product_copy_to_category', FILENAME_ATTRIBUTES_CONTROLLER, 'action=update_attributes_copy_to_category'); ?>
                <?php echo zen_draw_hidden_field('products_filter', $_GET['products_filter']); ?>
                <?php echo zen_draw_hidden_field('products_id', $_GET['products_filter']); ?>
                <?php echo zen_draw_hidden_field('products_update_id', $_GET['products_update_id']); ?>
                <?php echo zen_draw_hidden_field('copy_attributes', $_GET['copy_attributes']); ?>
                ...
                <table>
                  <tr>
                    <td class="main text-center"><?php echo TEXT_INFO_ATTRIBUTES_FEATURES_COPY_TO_CATEGORY . $products_filter . '<br />' . zen_get_products_name($products_filter); ?></td>
                    <td class="main"><?php echo TEXT_COPY_ATTRIBUTES_CONDITIONS . '<br />' . zen_draw_radio_field('copy_attributes', 'copy_attributes_delete', true) . ' ' . TEXT_COPY_ATTRIBUTES_DELETE . '<br />' . zen_draw_radio_field('copy_attributes', 'copy_attributes_update') . ' ' . TEXT_COPY_ATTRIBUTES_UPDATE . '<br />' . zen_draw_radio_field('copy_attributes', 'copy_attributes_ignore') . ' ' . TEXT_COPY_ATTRIBUTES_IGNORE; ?></td>
                  </tr>
                  <tr>
                    <td class="alert text-center"><?php echo TEXT_INFO_ATTRIBUTES_FEATURE_CATEGORIES_COPY_TO . '<br />' . zen_draw_products_pull_down_categories('categories_update_id', 'size="5"', '', true, true); ?></td>
                    <td class="main text-center"><?php echo zen_image_submit('button_copy.gif', IMAGE_COPY) . '&nbsp;&nbsp;' . '<a href="' . zen_href_link(FILENAME_ATTRIBUTES_CONTROLLER, 'products_filter=' . $products_filter . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')) . '">' . zen_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>'; ?></td>
                  </tr>
                </table>
                <?php echo '</form>'; ?>
            ...
            ?>
            <div style="height:20px;" class="text-center"><?php echo zen_draw_separator('pixel_black.gif', '90%', '2'); ?></div>
            <?php
            if ($action == '') {
              ?>
              <div class="table-responsive">
...
// start of attributes display
            if ($_GET['products_filter'] == '') {
              ?>
              <div>
                <h2 class="text-center align-middle"><?php echo HEADING_TITLE_ATRIB_SELECT; ?></h2>
              </div>
              <?php
            } else {
////
                ...
                <div class="table-responsive">
                  <table class="table-bordered">
                    ...
                    <tr>
                      ...
                      <td class="smallText text-center"><?php echo zen_image(DIR_WS_IMAGES . 'icon_yellow_off.gif') . zen_image(DIR_WS_IMAGES . 'icon_yellow_on.gif'); ?></td>
                      <td class="smallText text-center"><?php echo zen_image(DIR_WS_IMAGES . 'icon_blue_off.gif') . zen_image(DIR_WS_IMAGES . 'icon_blue_on.gif'); ?></td>
                      <td class="smallText text-center"><?php echo zen_image(DIR_WS_IMAGES . 'icon_orange_off.gif') . zen_image(DIR_WS_IMAGES . 'icon_orange_on.gif'); ?></td>
                      <td class="smallText text-center"><?php echo zen_image(DIR_WS_IMAGES . 'icon_pink_off.gif') . zen_image(DIR_WS_IMAGES . 'icon_pink_on.gif'); ?></td>
                      <td class="smallText text-center"><?php echo zen_image(DIR_WS_IMAGES . 'icon_purple_off.gif') . zen_image(DIR_WS_IMAGES . 'icon_purple_on.gif'); ?></td>
                      <td class="smallText text-center"><?php echo zen_image(DIR_WS_IMAGES . 'icon_red_off.gif') . zen_image(DIR_WS_IMAGES . 'icon_red_on.gif'); ?></td>
                      <td class="smallText text-center"><?php echo zen_image(DIR_WS_IMAGES . 'icon_status_yellow.gif'); ?></td>
                      <td class="smallText text-center"><?php echo zen_image(DIR_WS_IMAGES . 'icon_status_green.gif') . '&nbsp;' . zen_image(DIR_WS_IMAGES . 'icon_status_red.gif'); ?></td>
                    </tr>
                  </table>
                </div>
              <?php } ?>
                    ...
                    if (($action == 'update_attribute') && ($_GET['attribute_id'] == $attributes_value['products_attributes_id'])) {
                      ...
                      <tr>
                        <td colspan="10">
                          <table width="100%">
                            <tr>
                              <td class="pageHeading"><?php echo PRODUCTS_ATTRIBUTES_EDITING; ?></td>
                            </tr>
                            <tr>
                              <td>
                                <table cellpadding="4" cellspacing="2">
                                  <tr>
                                    <td class="smallText" valign="top" width="40">
                                      <?php echo $attributes_value['products_attributes_id']; ?>
                                ...
                                <table>
                                  <tr>
                                    ...
                                    <td class="pageHeading">
                                      <?php echo zen_get_option_name_language($attributes_value['options_id'], $_SESSION['languages_id']); ?>:
                                    </td>
                                    <td class="smallText"><?php echo TABLE_HEADING_OPT_VALUE; ?><br />
                                      <select name="values_id" size="10">
                                        <?php
// FIX HERE 2 - editing
                                        $values_values = $db->Execute("SELECT pov.*
                                                                       ...
                                                                       AND povtpo.products_options_id = '" . $attributes_value['options_id'] . "'
                                        ...
                                        foreach ($values_values as $value) {
                                          ...
                                          if ($attributes_value['options_values_id'] == $value['products_options_values_id']) {
                                            echo "\n" . '<option name="' . $value['products_options_values_name'] . '" value="' . $value['products_options_values_id'] . '" SELECTED>' . $value['products_options_values_name'] . $show_option_name . '</option>';
                                          } else {
                                            echo "\n" . '<option name="' . $value['products_options_values_name'] . '" value="' . $value['products_options_values_id'] . '">' . $value['products_options_values_name'] . $show_option_name . '</option>';
                                          }
...
// set image delete
                                ...
                                ?>
                                <div><?php echo TEXT_PRICES_AND_WEIGHTS; ?></div>
                                <div>
                                  <table class="table-bordered" align="left">
                                    <tr>
                                      <td class="smallText text-center"><?php echo TABLE_HEADING_OPT_PRICE; ?><br />
                                        <?php echo zen_draw_input_field('price_prefix', $attributes_value['price_prefix'], 'size="2"'); ?>
                                        &nbsp;
                                        <?php echo zen_draw_input_field('value_price', $attributes_value['options_values_price'], 'size="6"'); ?>
                                      </td>
                                      <td class="smallText text-center"><?php echo TABLE_HEADING_OPT_WEIGHT; ?><br />
                                        <?php echo zen_draw_input_field('products_attributes_weight_prefix', $attributes_value['products_attributes_weight_prefix'], 'size="2"'); ?>
                                        &nbsp;
                                        <?php echo zen_draw_input_field('products_attributes_weight', $attributes_value['products_attributes_weight'], 'size="6"'); ?>
                                      </td>
                                      <td class="smallText text-center"><?php echo TABLE_HEADING_OPT_SORT_ORDER; ?><br />
                                        <?php echo zen_draw_input_field('products_options_sort_order', $attributes_value['products_options_sort_order'], 'size="4"'); ?>
                                      </td>
                                      <td class="smallText text-center"><?php echo TABLE_HEADING_ATTRIBUTES_PRICE_ONETIME; ?><br />
                                        <?php echo zen_draw_input_field('attributes_price_onetime', $attributes_value['attributes_price_onetime'], 'size="6"'); ?>
                                      </td>
                                    </tr>
                                  </table>
                                  ...
                                  <?php if (ATTRIBUTES_ENABLED_PRICE_FACTOR == 'true') { ?>
                                    <table class="table-bordered" align="left">
                                      <tr>
                                        <td class="smallText text-center"><?php echo TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR . ' ' . TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_OFFSET; ?><br />
                                          <?php echo zen_draw_input_field('attributes_price_factor', $attributes_value['attributes_price_factor'], 'size="6"'); ?>
                                          &nbsp;&nbsp;
                                          <?php echo zen_draw_input_field('attributes_price_factor_offset', $attributes_value['attributes_price_factor_offset'], 'size="6"'); ?>
                                        </td>
                                        <td class="smallText text-center"><?php echo TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_ONETIME . ' ' . TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_OFFSET_ONETIME; ?><br />
                                          <?php echo zen_draw_input_field('attributes_price_factor_onetime', $attributes_value['attributes_price_factor_onetime'], 'size="6"'); ?>
                                          &nbsp;&nbsp;
                                          <?php echo zen_draw_input_field('attributes_price_factor_onetime_offset', $attributes_value['attributes_price_factor_onetime_offset'], 'size="6"'); ?>
                                        </td>
                                      </tr>
                                    </table>
                            ...
                            <?php if (ATTRIBUTES_ENABLED_QTY_PRICES == 'true') { ?>
                              <tr>
                                <td>
                                  <table class="table-bordered" align="left">
                                    <tr>
                                      <td class="smallText text-center"><?php echo TABLE_HEADING_ATTRIBUTES_QTY_PRICES; ?><br />
                                        <?php echo zen_draw_input_field('attributes_qty_prices', $attributes_value['attributes_qty_prices'], 'size="6"'); ?>
                                      </td>
                                      <td class="smallText text-center"><?php echo TABLE_HEADING_ATTRIBUTES_QTY_PRICES_ONETIME; ?><br />
                                        <?php echo zen_draw_input_field('attributes_qty_prices_onetime', $attributes_value['attributes_qty_prices_onetime'], 'size="6"'); ?>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                            ...
                            <?php if (ATTRIBUTES_ENABLED_TEXT_PRICES == 'true') { ?>
                              <tr>
                                <td>
                                  <table class="table-bordered" align="left">
                                    <tr>
                                      <td class="smallText text-center"><?php echo TABLE_HEADING_ATTRIBUTES_PRICE_WORDS . ' ' . TABLE_HEADING_ATTRIBUTES_PRICE_WORDS_FREE; ?><br />
                                        <?php echo zen_draw_input_field('attributes_price_words', $attributes_value['attributes_price_words'], 'size="6"'); ?>
                                        &nbsp;&nbsp;
                                        <?php echo zen_draw_input_field('attributes_price_words_free', $attributes_value['attributes_price_words_free'], 'size="6"'); ?>
                                      </td>
                                      <td class="smallText text-center"><?php echo TABLE_HEADING_ATTRIBUTES_PRICE_LETTERS . ' ' . TABLE_HEADING_ATTRIBUTES_PRICE_LETTERS_FREE; ?><br />
                                        <?php echo zen_draw_input_field('attributes_price_letters', $attributes_value['attributes_price_letters'], 'size="6"'); ?>
                                        &nbsp;&nbsp;
                                        <?php echo zen_draw_input_field('attributes_price_letters_free', $attributes_value['attributes_price_letters_free'], 'size="6"'); ?>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                            ...
                            <tr>
                              <td>
                                <table class="table-bordered">
                                  <tr>
                                    <td class="text-center" style="max-width: 150px;"><?php echo TEXT_ATTRIBUTES_FLAGS; ?></td>
                                    <td class="smallText text-center" style="max-width: 150px; background-color: #ff0;">
                                      <span style="font-weight:  bold;"><?php echo TEXT_ATTRIBUTES_DISPLAY_ONLY; ?></span><br/>
                                    ...
                                    <td class="smallText text-center" style="max-width: 150px; background-color: #2c54f5;">
                                      <span style="font-weight: bold;"><?php echo TEXT_ATTRIBUTES_IS_FREE; ?></span><br>
                                    ...
                                    <td class="smallText text-center" style="max-width: 150px; background-color: #ffa346;">
                                      <span style="font-weight: bold;"><?php echo TEXT_ATTRIBUTES_DEFAULT; ?></span><br>
                                    ...
                                    <td class="smallText text-center" style="max-width: 150px; background-color: #f0f;">
                                      <span style="font-weight: bold;"><?php echo TEXT_ATTRIBUTE_IS_DISCOUNTED; ?></span><br>
                                    ...
                                    <td class="smallText text-center" style="max-width: 150px; background-color: #d200f0;">
                                      <span style="font-weight: bold;"><?php echo TEXT_ATTRIBUTE_PRICE_BASE_INCLUDED; ?></span><br>
                                    ...
                                    <td class="smallText text-center" style="max-width: 150px;background-color: #ff0606;">
                                      <span style="font-weight: bold;"><?php echo TEXT_ATTRIBUTES_REQUIRED; ?></span><br>
...
// attributes images
                              ...
                              <tr>
                                <td>
                                  <table>
                                    <tr>
                                      <td class="main" valign="top"><?php echo TEXT_ATTRIBUTES_IMAGE . '<br />' . zen_draw_file_field('attributes_image') . '<br />' . zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . $attributes_value['attributes_image'] . zen_draw_hidden_field('attributes_previous_image', $attributes_value['attributes_image']); ?></td>
                                      ...
                                      <td class="main" valign="middle"><?php echo ($attributes_value['attributes_image'] != '' ? zen_image(DIR_WS_CATALOG_IMAGES . $attributes_value['attributes_image']) : ''); ?></td>
                            ...
                            if (DOWNLOAD_ENABLED == 'true') {
                              $download_query_raw = "SELECT products_attributes_filename, products_attributes_maxdays, products_attributes_maxcount
                                                     ...
                                                     WHERE products_attributes_id='" . $attributes_value['products_attributes_id'] . "'";
                              ...
                              <tr>
                                <td>
                                  <table>
                                    <tr>
                                      <td colspan="3"><?php echo TABLE_HEADING_DOWNLOAD; ?></td>
                                    <tr>
                                      <td><?php echo TABLE_TEXT_FILENAME . '<br />' . zen_draw_input_field('products_attributes_filename', $products_attributes_filename, zen_set_field_length(TABLE_PRODUCTS_ATTRIBUTES_DOWNLOAD, 'products_attributes_filename', 35)); ?></td>
                                      <td><?php echo TABLE_TEXT_MAX_DAYS . '<br />' . zen_draw_input_field('products_attributes_maxdays', $products_attributes_maxdays, 'size="5"'); ?></td>
                                      <td><?php echo TABLE_TEXT_MAX_COUNT . '<br />' . zen_draw_input_field('products_attributes_maxcount', $products_attributes_maxcount, 'size="5"'); ?></td>
                                    </tr>
                                  </table>
                                </td>
                              </tr>
                      ...
                      <tr>
                        ...
                        <td colspan="3" class="text-center"><?php echo zen_image_submit('button_confirm.gif', IMAGE_CONFIRM); ?>&nbsp;&nbsp;<a href="<?php echo zen_href_link(FILENAME_ATTRIBUTES_CONTROLLER, (isset($_GET['option_page']) ? '&option_page=' . $_GET['option_page'] . '&' : '') . (isset($_GET['value_page']) ? '&value_page=' . $_GET['value_page'] . '&' : '') . (isset($_GET['attribute_page']) ? '&attribute_page=' . $_GET['attribute_page'] : '') . '&products_filter=' . $products_filter . '&current_category_id=' . $current_category_id); ?>"><?php echo zen_image_button('button_cancel.gif', IMAGE_CANCEL); ?></a></td>
                        <td colspan="3">&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="10">&nbsp;</td>
...
// $attributes_values
                      ...
                      <tr>
                        <td class="smallText"><?php echo $attributes_value['products_attributes_id']; ?></td>
                        <td class="smallText"></td>
                        <td class="smallText"><?php echo $options_name; ?></td>
                        <td class="smallText"><?php echo ($attributes_value['attributes_image'] != '' ? zen_image(DIR_WS_IMAGES . 'icon_status_yellow.gif') . '&nbsp;' : '&nbsp;&nbsp;') . $values_name; ?></td>
                        <td class="smallText text-right"><?php echo $attributes_value['price_prefix']; ?>&nbsp;<?php echo $attributes_value['options_values_price']; ?></td>
                        <td class="smallText text-right"><?php echo $attributes_value['products_attributes_weight_prefix']; ?>&nbsp;<?php echo $attributes_value['products_attributes_weight']; ?></td>
                        <td class="smallText text-right"><?php echo $attributes_value['products_options_sort_order']; ?></td>
                        <?php
                        if ($action == '') {
                          ?>
                          <td>
                        ...
                        ?>
                        <td class="smallText text-right"><?php echo $attributes_price_final . $new_attributes_price . ' ' . $attributes_price_final_onetime; ?></td>
                        <?php
                        if ($action != '') {
                          ?>
                          <td width="120">&nbsp;</td>
...
//////////////////////////////////////////////////////////////
                  ...
                  if (($action != 'update_attribute' && $action != 'delete_product_attribute')) {
                    ...
                    <!-- bof_adding -->
                    <tr>
                      <td colspan="3" class="pageHeading"><?php echo PRODUCTS_ATTRIBUTES_ADDING; ?></td>
                      <td colspan="4" class="main"><?php echo TEXT_ATTRIBUTES_INSERT_INFO; ?></td>
                      <td colspan="3" class="text-center" height="30" valign="bottom">
                        <?php
                        if ($action == '') {
                    ...
                    <tr>
                      <td class="pageHeading" colspan="10">
                        <table cellpadding="4" cellspacing="2" width="100%">
                          <tr>
                            <td width="40"><?php echo $next_id; ?></td>
                          ...
                          <tr>
                            ...
                            <td><?php echo TABLE_HEADING_OPT_VALUE; ?><br />
...
// set defaults for copying
                        ...
                        <table>
                          ...
                          <tr>
                            <td>
                              <table class="table-bordered">
                                <tr>
                                  <td class="text-center"><?php echo TABLE_HEADING_OPT_PRICE; ?><br />
                                    <?php echo zen_draw_input_field('price_prefix', $default_price_prefix, 'size="2"'); ?>
                                    &nbsp;
                                    <?php echo zen_draw_input_field('value_price', '', 'size="6"'); ?>
                                  </td>
                                  <td class="text-center"><?php echo TABLE_HEADING_OPT_WEIGHT; ?><br />
                                    <?php echo zen_draw_input_field('products_attributes_weight_prefix', $default_products_attributes_weight_prefix, 'size="2"'); ?>
                                    &nbsp;
                                    <?php echo zen_draw_input_field('products_attributes_weight', '', 'size="6"'); ?>
                                  </td>
                                  <td class="text-center"><?php echo TABLE_HEADING_OPT_SORT_ORDER; ?><br />
                                    <?php echo zen_draw_input_field('products_options_sort_order', '', 'size="4"'); ?>
                                  </td>
                                  <td class="text-center"><?php echo TABLE_HEADING_ATTRIBUTES_PRICE_ONETIME; ?><br />
                                    <?php echo zen_draw_input_field('attributes_price_onetime', '', 'size="6"'); ?>
                                  </td>
                                </tr>
                              </table>
                            </td>
                            ...
                            <?php if (ATTRIBUTES_ENABLED_PRICE_FACTOR == 'true') { ?>
                              <td>
                                <table class="table-bordered">
                                  <tr>
                                    <td class="text-center"><?php echo TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR . '&nbsp;&nbsp;' . TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_OFFSET; ?><br />
                                      <?php echo zen_draw_input_field('attributes_price_factor', '', 'size="6"'); ?>
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      <?php echo zen_draw_input_field('attributes_price_factor_offset', '', 'size="6"'); ?>
                                    </td>
                                    <td class="text-center">&nbsp;<?php echo TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_ONETIME . '&nbsp;&nbsp;' . TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_OFFSET_ONETIME; ?><br />
                                      <?php echo zen_draw_input_field('attributes_price_factor_onetime', '', 'size="6"'); ?>
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      <?php echo zen_draw_input_field('attributes_price_factor_onetime_offset', '', 'size="6"'); ?>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                              <?php
                            } else {// ATTRIBUTES_ENABLED_PRICE_FACTOR
                              ?>
                              <td>&nbsp;</td>
                              <?php
                            }
                          ...
                          <?php if (ATTRIBUTES_ENABLED_QTY_PRICES == 'true') { ?>
                            <tr>
                              <td colspan="2">
                                <table class="table-bordered">
                                  <tr>
                                    <td class="text-center"><?php echo TABLE_HEADING_ATTRIBUTES_QTY_PRICES; ?><br />
                                      <?php echo zen_draw_input_field('attributes_qty_prices', '', 'size="6"'); ?>
                                    </td>
                                    <td class="text-center"><?php echo TABLE_HEADING_ATTRIBUTES_QTY_PRICES_ONETIME; ?><br />
                                      <?php echo zen_draw_input_field('attributes_qty_prices_onetime', '', 'size="6"'); ?>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                          ...
                          <?php if (ATTRIBUTES_ENABLED_TEXT_PRICES == 'true') { ?>
                            <tr>
                              <td colspan="2">
                                <table class="table-bordered">
                                  <tr>
                                    <td class="text-center"><?php echo TABLE_HEADING_ATTRIBUTES_PRICE_WORDS . '&nbsp;&nbsp;' . TABLE_HEADING_ATTRIBUTES_PRICE_WORDS_FREE; ?><br />
                                      <?php echo zen_draw_input_field('attributes_price_words', '', 'size="6"'); ?>
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      <?php echo zen_draw_input_field('attributes_price_words_free', '', 'size="6"'); ?>
                                    </td>
                                    <td class="text-center"><?php echo TABLE_HEADING_ATTRIBUTES_PRICE_LETTERS . '&nbsp;&nbsp;' . TABLE_HEADING_ATTRIBUTES_PRICE_LETTERS_FREE; ?><br />
                                      <?php echo zen_draw_input_field('attributes_price_letters', '', 'size="6"'); ?>
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      <?php echo zen_draw_input_field('attributes_price_letters_free', '', 'size="6"'); ?>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                    ...
                    <tr>
                      <td class="pageHeading" colspan="10">
                        <table class="table-bordered">
                          <tr>
                            <td class="smallText text-center" style="max-width:150px;"><?php echo TEXT_ATTRIBUTES_FLAGS; ?></td>
                            <td class="smallText text-center" style="max-width:150px; background-color: #ff0;">
                              <span style="font-weight: bold;"><?php echo TEXT_ATTRIBUTES_DISPLAY_ONLY; ?></span><br />
                              <?php echo zen_draw_radio_field('attributes_display_only', '0', $off_attributes_display_only) . '&nbsp;' . TABLE_HEADING_NO . ' ' . zen_draw_radio_field('attributes_display_only', '1', $on_attributes_display_only) . '&nbsp;' . TABLE_HEADING_YES; ?>
                            </td>
                            <td class="smallText text-center" style="max-width:150px; background-color: #2C54F5;">
                              <span style="font-weight: bold;"><?php echo TEXT_ATTRIBUTES_IS_FREE; ?></span><br />
                              <?php echo zen_draw_radio_field('product_attribute_is_free', '0', $off_product_attribute_is_free) . '&nbsp;' . TABLE_HEADING_NO . ' ' . zen_draw_radio_field('product_attribute_is_free', '1', $on_product_attribute_is_free) . '&nbsp;' . TABLE_HEADING_YES; ?></td>
                            <td class="smallText text-center" style="max-width:150px; background-color: #ffa346;">
                              <span style="font-weight: bold;"><?php echo TEXT_ATTRIBUTES_DEFAULT; ?></span><br />
                              <?php echo zen_draw_radio_field('attributes_default', '0', $off_attributes_default) . '&nbsp;' . TABLE_HEADING_NO . ' ' . zen_draw_radio_field('attributes_default', '1', $on_attributes_default) . '&nbsp;' . TABLE_HEADING_YES; ?>
                            </td>
...
// attributes images
                      ...
                      <tr>
                        <td class="pageHeading" colspan="9">
                          <table>
                            <tr>
                    ...
                    if (DOWNLOAD_ENABLED == 'true') {
                      ...
                      <!-- bof Down loads OFF -->
                      <tr>
                        <td colspan="10"><?php echo TEXT_DOWNLOADS_DISABLED; ?></td>
                      </tr>
                      <!-- eof Downloads OFF -->
                      <?php
