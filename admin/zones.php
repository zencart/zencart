        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 configurationColumnLeft">
          <table class="table table-hover" role="listbox">
            ...
            <tbody>
                ...
                $zones_split = new splitPageResults($_GET['zone_page'], (int)zen_config('MAX_DISPLAY_SEARCH_RESULTS'), $zones_query_raw, $zones_query_numrows, 'countries_name', zen_field_length(TABLE_COUNTRIES, 'countries_name'));
