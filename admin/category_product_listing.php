            ...
            <table class="table table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th class="nomobile"><?php echo TABLE_HEADING_MODEL; ?></th>
                  <th class="text-right nomobile"><?php echo TABLE_HEADING_PRICE; ?></th>
                  <th class="text-right nomobile">&nbsp;</th>
                  <th class="text-right nomobile"><?php echo TABLE_HEADING_QUANTITY; ?></th>
                  <th class="text-right nomobile"><?php echo TABLE_HEADING_STATUS; ?></th>
                  <?php
                  if ($action == '') {
                    ?>
                    <th class="text-right nomobile"><?php echo TABLE_HEADING_CATEGORIES_SORT_ORDER; ?></th>
...
// Get parent_id for subcategories if search
                ...
                <tr onclick="document.location.href = '<?php echo zen_href_link(FILENAME_CATEGORY_PRODUCT_LISTING, zen_get_path($category['categories_id'])); ?>'" role="button">
                  <td class="text-right nomobile"><?php echo $category['categories_id']; ?></td>
                  <td nomobile><?php echo zen_image(DIR_WS_ICONS . 'folder.gif', ICON_FOLDER); ?>&nbsp;<strong><?php echo $category['categories_name']; ?></strong></td>
                  <td class="text-center nomobile">&nbsp;</td>
                  <td class="text-right nomobile"><?php echo zen_get_products_sale_discount('', $category['categories_id'], true); ?></td>
                  <td class="text-center nomobile">&nbsp;</td>
                  <td class="text-right nomobile">
                      <?php
...
// Get categories_id for product if search
                ...
                <tr>
                  ...
                  <td class="nomobile"><?php echo $product['products_model']; ?></td>
                  <td colspan="2" class="text-right nomobile"><?php echo zen_get_products_display_price($product['products_id']); ?></td>
                  <td class="text-right nomobile"><?php echo $product['products_quantity']; ?></td>
                  <td class="text-right nomobile">
                      <?php
                  ...
                  if ($action == '') {
                    ?>
                    <td class="text-right nomobile"><?php echo $product['products_sort_order']; ?></td>
                    <td class="text-right">
