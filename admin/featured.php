 ...
 * @version $Id: Scott C Wilson 2022 Jul 06 Modified in v1.5.8-alpha $
      ...
      <?php } else { ?>
        <div class="row">
          ...
          <div class="col-sm-offset-2 col-sm-4">
            <?php echo zen_draw_form('search', FILENAME_FEATURED, '', 'get', 'class="form-horizontal"'); ?>
            <?php $keywords = (isset($_GET['search']) && zen_not_null($_GET['search'])) ? zen_db_input(zen_db_prepare_input($_GET['search'])) : ''; ?>
            <div class="form-group">
              <?php echo zen_draw_label(TEXT_SEARCH_FEATURED, 'search', 'class="control-label col-sm-3"'); ?>
              <div class="col-sm-9">
            ...
            if (isset($_GET['search']) && zen_not_null($_GET['search'])) {
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9 text-right">
                  <?php echo zen_output_string_protected($keywords); ?>&nbsp;<a href="<?php echo zen_href_link(FILENAME_FEATURED); ?>" class="btn btn-default" role="button"><?php echo IMAGE_RESET; ?></a>
                </div>
              </div>
            <?php } ?>
            <?php echo '</form>'; ?>
                      ...
                      <?php if (($featured['featured_date_available'] !== '0001-01-01' && $featured['featured_date_available'] !== '') || ($featured['expires_date'] !== '0001-01-01' && $featured['expires_date'] !== '')) { ?>
                        <button type="submit" class="btn btn-status" style="cursor: initial;">
                          <?php if ($featured['status'] === '1') { ?>
                            <i class="fa fa-square fa-lg txt-status-on" title="<?php echo TEXT_FEATURED_ACTIVE; ?>: <?php echo TEXT_FEATURED_STATUS_BY_DATE; ?>"></i>
                          <?php } else { ?>
                            <i class="fa fa-square fa-lg txt-status-off" title="<?php echo TEXT_FEATURED_INACTIVE; ?>: <?php echo TEXT_FEATURED_STATUS_BY_DATE; ?>"></i>
                          <?php } ?>
                        </button>
                      <?php } else { ?>
                        ...
                        <?php if ($featured['status'] === '1') { ?>
                          <button type="submit" class="btn btn-status">
                            <i class="fa fa-square fa-lg txt-status-on" title="<?php echo TEXT_FEATURED_ACTIVE; ?>"></i>
                          </button>
                          <?php echo zen_draw_hidden_field('flag', '0'); ?>
                        <?php } else { ?>
                          <button type="submit" class="btn btn-status">
                            <i class="fa fa-square fa-lg txt-status-off" title="<?php echo TEXT_FEATURED_INACTIVE; ?>"></i>
                          </button>
