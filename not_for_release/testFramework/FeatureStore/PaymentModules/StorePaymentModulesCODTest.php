...
class StorePaymentModulesCODTest extends zcFeatureTestCaseStore
{
    ...
    public function setUp(): void
    {
        ...
        $this->installPaymentModule('COD', 'cod');
    }
   ...
   public function I_can_checkout_with_a_COD()
   {
       ...
       $this->assertStringContainsString('Cash on Delivery', (string)$response->getContent());
       $this->browser->submitForm('Continue', [
       ]);
...
//
     ...
     * @test
     */
   public function I_cannot_checkout_with_a_COD_with_invalid_zone()
   {
       $this->setConfiguration('MODULE_PAYMENT_COD_ZONE', '9999');
       $this->createCustomerAccountOrLogin('florida-basic1');
       $this->browser->request('GET', HTTP_SERVER . '/index.php?main_page=product_info&products_id=25');
       $response = $this->browser->getResponse();
       $this->assertStringContainsString('Microsoft', (string)$response->getContent());
