...
class CreateCustomersBasketAttributesTable extends Migration
{
    ...
    public function up()
    {
        Capsule::schema()->create('customers_basket_attributes', function (Blueprint $table) {
            ...
            $table->index(['customers_id', Capsule::raw('products_id(36)')], 'idx_cust_id_prod_id_zen');
    ...
    {
        Capsule::schema()->dropIfExists('customers_basket_attributes');
    }
}
