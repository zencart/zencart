...
class CreateProductTypeLayoutTable extends Migration
{
    ...
    public function up()
    {
        Capsule::schema()->create('product_type_layout', function (Blueprint $table) {
            ...
            $table->index(['configuration_key', Capsule::raw('configuration_value(10)')], 'idx_key_value_zen');
//            $table->index(['configuration_key', 'configuration_value`(10'], 'idx_key_value_zen');
    ...
    {
        Capsule::schema()->dropIfExists('product_type_layout');
    }
}
