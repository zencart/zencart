...
class CreateWhosOnlineTable extends Migration
{
    ...
    public function up()
    {
        Capsule::schema()->create('whos_online', function (Blueprint $table) {
            ...
            $table->index([Capsule::raw('last_page_url(191)')], 'idx_last_page_url_zen');
    ...
    {
        Capsule::schema()->dropIfExists('whos_online');
    }
}
