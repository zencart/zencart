...
class CreatePaypalTable extends Migration
{
    ...
    public function up()
    {
        Capsule::schema()->create('paypal', function (Blueprint $table) {
            ...
            $table->decimal('mc_gross', 15, 4)->default(0.0000);
            $table->decimal('mc_fee', 15, 4)->default(0.0000);
            $table->decimal('payment_gross', 15, 4)->nullable();
            $table->decimal('payment_fee', 15, 4)->nullable();
            $table->decimal('settle_amount', 15, 4)->nullable();
            $table->char('settle_currency', 3)->nullable();
            $table->decimal('exchange_rate', 15, 4)->nullable();
            $table->string('notify_version', 6)->default('');
    ...
    {
        Capsule::schema()->dropIfExists('paypal');
    }
}
