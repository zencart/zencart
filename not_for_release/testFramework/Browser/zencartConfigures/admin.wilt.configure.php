 ...
 */
define('HTTP_SERVER', 'https://zc-current.test');
/**
 ...
 */
define('HTTP_CATALOG_SERVER', 'https://zc-current.test');
define('HTTPS_CATALOG_SERVER', 'https://zc-current.test');
...
define('DB_SERVER_USERNAME', 'phpmyadmin');
define('DB_SERVER_PASSWORD', '1kallavc');
define('DB_DATABASE', 'zccurrent');
