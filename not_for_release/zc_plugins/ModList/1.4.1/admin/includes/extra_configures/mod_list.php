...
define('BUILT_IN_ORDER_TOTALS', array(
'ot_cod_fee.php',
'ot_coupon.php',
...
define('BUILT_IN_SHIPPINGS', array(
'flat.php',
'freeoptions.php',
'freeshipper.php',
'item.php',
...
define('OPTIONAL_TABLES', array( 
  'linkpoint_api'
)); 

define('BUILT_IN_PAYMENTS', array(
'authorizenet.php',
