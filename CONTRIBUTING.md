...
* Each suggestion/report/pull-request should be separate. Don't mix multiple issues into one. See git guidelines at [docs.zen-cart.com](https://docs.zen-cart.com/dev)
* Code submissions should comply with the [Coding Standards](http://docs.zen-cart.com/dev)
* If reporting a bug/issue, please provide exact steps which one can take to recreate the bug, starting from a brand new fresh install. See [Guidelines for Reporting Bugs](http://docs.zen-cart.com/dev)
