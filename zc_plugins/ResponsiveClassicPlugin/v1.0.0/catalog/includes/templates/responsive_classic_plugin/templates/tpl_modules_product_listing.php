...
<?php
  if ($listing_split->number_of_rows && in_array($tplSetting->PREV_NEXT_BAR_LOCATION, ['1', '3'], true)) {
?>
...
<?php if ($listing_split->number_of_rows && in_array($tplSetting->PREV_NEXT_BAR_LOCATION, ['1', '3'], true)) { ?>
</div>
<?php } ?>
...
<?php if ($listing_split->number_of_rows && in_array($tplSetting->PREV_NEXT_BAR_LOCATION, ['2', '3'], true)) { ?>
<div class="prod-list-wrap group">
