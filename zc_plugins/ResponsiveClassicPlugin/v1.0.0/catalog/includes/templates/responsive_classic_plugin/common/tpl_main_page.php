...
if ($flag_disable_right || zen_config('COLUMN_RIGHT_STATUS') === '0') {
...
if ($flag_disable_left || zen_config('COLUMN_LEFT_STATUS') === '0') {
...
<?php
  ...
  *
  */
  if (zen_config('CUSTOMERS_APPROVAL_AUTHORIZATION') === '1' && zen_config('CUSTOMERS_AUTHORIZATION_FOOTER_OFF') === 'true' && ($_SESSION['customers_authorization'] != 0 || $_SESSION['customer_id'] == '')) {
    $flag_disable_footer = true;
  }
