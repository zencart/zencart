...
UPDATE configuration SET configuration_title = 'Suburb (second address line)', configuration_description = 'Display a second address field "Suburb"" during account creation and with account information' WHERE configuration_key = 'ACCOUNT_SUBURB';
