...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function, val_function) VALUES ('Include FontAwesome v4 shim CSS','FONTAWESOME_V4_SHIM','false','Should the optional v4 shim CSS file, which enables obsolete V4 font glyphs, be loaded by admin pages? This is to support old addons that use these deprecated glyphs.', 1,350,now(),null,'zen_cfg_select_option(array(''true'', ''false''),',null);
