...
ALTER TABLE address_book MODIFY entry_suburb varchar(128) default NULL;
...
ALTER TABLE orders MODIFY customers_suburb varchar(128) default NULL;
...
ALTER TABLE orders MODIFY delivery_suburb varchar(128) default NULL;
...
ALTER TABLE orders MODIFY billing_suburb varchar(128) default NULL;
