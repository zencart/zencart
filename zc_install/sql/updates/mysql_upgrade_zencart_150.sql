...
ALTER TABLE admin ADD COLUMN pwd_last_change_date datetime NOT NULL default '1970-01-01 00:00:01';
ALTER TABLE admin ADD COLUMN reset_token varchar(60) NOT NULL default '';
ALTER TABLE admin ADD COLUMN last_modified datetime NOT NULL default '1970-01-01 00:00:01';
ALTER TABLE admin ADD COLUMN last_login_date datetime NOT NULL default '1970-01-01 00:00:01';
...
ALTER TABLE admin ADD COLUMN last_failed_attempt datetime NOT NULL default '1970-01-01 00:00:01';
