...
ALTER TABLE orders ADD language_id int(11) NOT NULL DEFAULT '1';
...
INSERT INTO dashboard_widgets (widget_key, widget_group, widget_status, widget_icon, widget_theme) VALUES ('whos-online', 'whos-online', 1, 'fa-area-chart', 'bg-light-blue-gradient');
...
,('whos-online', 1, 2, 2, 'fa-area-chart', 'bg-light-blue-gradient')
;
