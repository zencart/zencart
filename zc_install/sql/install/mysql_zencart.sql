...
VALUES ('configMyStore', 'BOX_CONFIGURATION_MY_STORE', 'FILENAME_CONFIGURATION', 'gID=1', 'configuration', 'Y', 1),
       ...
       ('configCheckoutSettings', 'BOX_CONFIGURATION_CHECKOUT_SETTINGS', 'FILENAME_CONFIGURATION', 'gID=26', 'configuration', 'Y', 26),       
       ('configWidgets', 'BOX_CONFIGURATION_WIDGET', 'FILENAME_CONFIGURATION', 'gID=27', 'configuration', 'Y', 27),
       ('configEzPagesSettings', 'BOX_CONFIGURATION_EZPAGES_SETTINGS', 'FILENAME_CONFIGURATION', 'gID=28', 'configuration', 'Y', 28),
       ...
       ('reportSalesWithGraphs', 'BOX_REPORTS_SALES_REPORT_GRAPHS', 'FILENAME_STATS_SALES_REPORT_GRAPHS', '', 'reports', 'Y', 4);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Email Archiving Active?', 'EMAIL_ARCHIVE', 'None', 'If you wish to have email messages archived/stored when sent, set this to "All".', '12', '6', 'zen_cfg_select_option(array(\'All\', \'None\', \'All Except Copies\'),', now());
...
INSERT INTO configuration_group VALUES (28, 'EZ-Pages Settings', 'EZ-Pages Settings', 28, '1');
