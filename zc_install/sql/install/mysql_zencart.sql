...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Show Category Counts Including Sub-Category Products', 'COUNT_SUB_CATEGORIES', 'true', 'include products in sub categories in categories count', '1', '19', 'zen_cfg_select_option(array(\'true\', \'false\'), ', now());
