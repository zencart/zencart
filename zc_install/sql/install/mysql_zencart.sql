...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Autoenable product that are disabled and are now available based on date', 'ENABLE_DISABLED_UPCOMING_PRODUCT', '0', 'While this feature is on, navigation of the catalog on or after the product\'s date available will auto-enable the product that were hidden (disabled).<br /><br />0= off<br />1= on', '9', '12', 'zen_cfg_select_option(array(\'0\', \'1\'), ', now());
