...
'  define(\'DIR_WS_CATALOG_IMAGES\', HTTPS_CATALOG_SERVER . DIR_WS_HTTPS_CATALOG . \'images/\');' . "\n" .
'  define(\'DIR_WS_CATALOG_TEMPLATE\', HTTPS_CATALOG_SERVER . DIR_WS_HTTPS_CATALOG . \'includes/templates/\');' . "\n" .
'  define(\'DIR_WS_CATALOG_LANGUAGES\', HTTPS_CATALOG_SERVER . DIR_WS_HTTPS_CATALOG . \'includes/languages/\');' . "\n" .
'' . "\n" .
...
'  // For SQL_CACHE_METHOD, you can select from:  none or database' . "\n" .
'  // DIR_FS_SQL_CACHE should point to the cache folder on your site, and that folder should be made writable' . "\n" .
