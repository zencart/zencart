 ...
 */
namespace ZenCart\Admin\AjaxDispatch;
/**
 * Class AjaxDispatch
 * @package ZenCart\Admin\AjaxDispatch
 */
class AjaxDispatch extends \base
{
    ...
    public static function run($action, $request)
    {
        ...
        $namespaceClassName = 'ZenCart\\Admin\\Controllers\\' . $className;
        $fileName =  DIR_CATALOG_LIBRARY . 'zencart/admin/Controllers/src/' . $className . '.php';
