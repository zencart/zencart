...
use ZenCart\Admin\Lead\Builder;
use ZenCart\Platform\QueryBuilder;
use ZenCart\Platform\Request as Request;
use ZenCart\Platform\Paginator\Paginator as Paginator;
use ZenCart\Platform\listingBox\PaginatorBuilder as PaginatorBuilder;
use ZenCart\Admin\Services\LeadRoutes as LeadService;
...
abstract class AbstractLeadController extends AbstractController
{
    ...
    public function mainExecute()
    {
        ...
        $this->listingBox->buildResults($this->queryBuilder, $this->dbConn,
            new \ZenCart\Platform\listingBox\DerivedItemManager, $this->paginatortBuilder->getPaginator());
