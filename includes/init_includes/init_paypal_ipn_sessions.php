...
ipn_debug_email(
    ...
    '*** Originating IP: ' . $_SERVER['REMOTE_ADDR'] . '  ' . (zen_config('SESSION_IP_TO_HOST_ADDRESS') === 'true' ? @gethostbyaddr($_SERVER['REMOTE_ADDR']) : '') . ($_SERVER['HTTP_USER_AGENT'] == '' ? '' : "\n" .
...
if (zen_config('MODULE_PAYMENT_PAYPAL_TESTING') === 'Test') {
