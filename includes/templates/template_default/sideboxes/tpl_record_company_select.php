...
$content .= zen_draw_form('record_company_form', zen_href_link(FILENAME_DEFAULT, '', '', false), 'get', 'class="sidebox-select-form"');
...
$content .= zen_draw_pull_down_menu('record_company_id', $record_company_array, $default_selection, 'size="' . zen_config('MAX_RECORD_COMPANY_LIST') . '"' . $required);
