...
$content .= zen_draw_form('music_genres_form', zen_href_link(FILENAME_DEFAULT, '', '', false), 'get', 'class="sidebox-select-form"');
...
$content .= zen_draw_pull_down_menu('music_genre_id', $music_genres_array, $default_selection, 'size="' . zen_config('MAX_MUSIC_GENRES_LIST') . '"' . $required);
