...
<?php if ( $listing_split->number_of_rows > 0 && ($tplSetting->PREV_NEXT_BAR_LOCATION === '1' || $tplSetting->PREV_NEXT_BAR_LOCATION === '3') ) {
?>
...
<?php if ( $listing_split->number_of_rows > 0 && ($tplSetting->PREV_NEXT_BAR_LOCATION === '2' || $tplSetting->PREV_NEXT_BAR_LOCATION === '3') ) {
?>
