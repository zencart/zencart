...
<?php
    echo zen_draw_input_field('state', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_state', '40') . ' id="state"' . ((int)ENTRY_STATE_MIN_LENGTH > 0 ? ' placeholder="' . ENTRY_STATE_TEXT . '" required' : ''));
