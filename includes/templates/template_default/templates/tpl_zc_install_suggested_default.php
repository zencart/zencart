...
<html <?php echo HTML_PARAMS; ?>>
  ...
  <body>
  <div class="container">
    <img src="<?php echo $relPath; ?>includes/templates/template_default/images/logo.gif" alt="Zen Cart&reg;" title="Zen Cart&reg;" <!--  JET  width="192" height="68" border="0" -->class="h-img">
