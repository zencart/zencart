...
<?php echo zen_draw_input_field($antiSpamFieldName, '', ' size="60" id="RAS" style="visibility:hidden; display:none;" autocomplete="off" aria-hidden="true"'); ?>

    <div class="buttonRow forward"><?php echo zen_image_submit(BUTTON_IMAGE_SUBMIT, BUTTON_SUBMIT_ALT); ?></div>
<br class="clearBoth">

<div id="reviewsWriteReviewsNotice" class="notice"><?php echo TEXT_NO_HTML . (zen_config('REVIEWS_APPROVAL') === '1' ? '<br>' . TEXT_APPROVAL_REQUIRED: ''); ?></div>
</form>
</div>
