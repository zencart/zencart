...
<div class="ratingRow">
<?php echo zen_draw_radio_field('rating', '1', $rating === 1 ? 1 : '', 'id="rating-1"'); ?>
...
<?php echo zen_draw_radio_field('rating', '2', $rating === 2 ? 1 : '', 'id="rating-2"'); ?>
...
<?php echo zen_draw_radio_field('rating', '3', $rating === 3 ? 1 : '', 'id="rating-3"'); ?>
...
<?php echo zen_draw_radio_field('rating', '4', $rating === 4 ? 1 : '', 'id="rating-4"'); ?>
...
<?php echo zen_draw_radio_field('rating', '5', $rating === 5 ? 1 : '', 'id="rating-5"'); ?>
