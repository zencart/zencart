...
<script title="jQuery check - template">window.jQuery || document.write('<script src="<?php echo $template->get_template_dir('.js',DIR_WS_TEMPLATE, $current_page_base,'jscript'); ?>/jquery.min.js"><\/script>');</script>
<?php } ?>
<script title="jQuery check - template_default">window.jQuery || document.write('<script src="<?php echo $template->get_template_dir('.js','template_default', $current_page_base,'jscript'); ?>/jquery.min.js"><\/script>');</script>
