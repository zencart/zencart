...
//            $how_many++;
            $link = TEXT_PRODUCT_NEW_LISTING_MULTIPLE_ADD_TO_CART . "<input type=\"text\" name=\"products_id[" . $products_new->fields['products_id'] . "]\" value=\"0\" size=\"4\" aria-label='" . TEXT_PRODUCT_NEW_LISTING_MULTIPLE_ADD_TO_CART . "products_id['" . (int)$products_new->fields['products_id'] . "]'" . " />";
          } else {
