...
<?php } else { ?>
  <table id="quantityDiscountsDetails">
    <tr>
      <td colspan="<?php echo $columnCount+1; ?>" style="text-align:center">
<?php
...
?>
    ...
    <tr>
      <td style="text-align:center"><?php echo $show_qty . '<br />' . $currencies->display_price($show_price, zen_get_tax_rate($products_tax_class_id)); ?></td>

<?php
  foreach($quantityDiscounts as $key=>$quantityDiscount) {
?>
<td style="text-align:center"><?php echo $quantityDiscount['show_qty'] . '<br />' . $currencies->display_price($quantityDiscount['discounted_price'], zen_get_tax_rate($products_tax_class_id)); ?></td>
<?php
    $disc_cnt++;
...
?>
    <td style="text-align:center" colspan="<?php echo ($columnCount+1 - $disc_cnt)+1; ?>"> &nbsp; </td>
<?php } ?>
    </tr>
<?php
