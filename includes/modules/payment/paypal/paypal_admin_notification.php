...
// display all paypal status fields (in admin Orders page):
          ...
          $output .= '</td><td class="main">'."\n";
          $output .= $esc($ipn->fields['payer_email'])."\n";
          $output .= '</td></tr>'."\n";

          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_PAYPAL_ENTRY_EBAY_ID."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $esc($ipn->fields['ebay_address_id'])."\n";
          $output .= '</td></tr>'."\n";

          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_PAYPAL_ENTRY_PAYER_ID."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $esc($ipn->fields['payer_id'])."\n";
          $output .= '</td></tr>'."\n";

          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_PAYPAL_ENTRY_PAYER_STATUS."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $esc($ipn->fields['payer_status'])."\n";
          $output .= '</td></tr>'."\n";

          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_PAYPAL_ENTRY_ADDRESS_STATUS."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $esc($ipn->fields['address_status'])."\n";
          $output .= '</td></tr>'."\n";

          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_PAYPAL_ENTRY_TXN_TYPE."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $esc($ipn->fields['txn_type'])."\n";
          $output .= '</td></tr>'."\n";

          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_PAYPAL_ENTRY_TXN_ID."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= '<a href="https://www.paypal.com/us/cgi-bin/webscr?cmd=_view-a-trans&id=' . $esc($ipn->fields['txn_id']) . '" rel="noopener" target="_blank">' . $esc($ipn->fields['txn_id']) . '</a>' ."\n";
          $output .= '</td></tr>'."\n";

          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_PAYPAL_ENTRY_PARENT_TXN_ID."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $esc($ipn->fields['parent_txn_id'])."\n";
          $output .= '</td></tr>'."\n";
          ...
          $output .= '</td><td class="main">'."\n";
          $output .= $esc($ipn->fields['payment_type'])."\n";
          $output .= '</td></tr>'."\n";

          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_PAYPAL_ENTRY_PAYMENT_STATUS."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $esc($ipn->fields['payment_status'])."\n";
          $output .= '</td></tr>'."\n";

          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_PAYPAL_ENTRY_PENDING_REASON."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $esc($ipn->fields['pending_reason'])."\n";
          $output .= '</td></tr>'."\n";

          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_PAYPAL_ENTRY_INVOICE."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $esc($ipn->fields['invoice'])."\n";
          $output .= '</td></tr>'."\n";

          $output .= '<tr><td class="main">'."\n";
          $output .= MODULE_PAYMENT_PAYPAL_ENTRY_PAYMENT_DATE."\n";
          $output .= '</td><td class="main">'."\n";
          $output .= $esc(zen_datetime_short($ipn->fields['payment_date']))."\n";
          $output .= '</td></tr>'."\n";
        ...
        if ($ipn->fields['memo'] != '') {
          ...
          $output .= nl2br($esc($ipn->fields['memo']), false)."\n";
          $output .= '</td></tr>'."\n";
          $output .= '</table></td>'."\n";
        }
          $output .= '</tr>'."\n";
