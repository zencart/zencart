 ...
 * @version $Id: record_companies.php  Modified in v1.6.0 $
 */
...
// Display a list
    ...
    foreach($record_company as $result) {
      $elipsis = (strlen($result['record_company_name']) > (int)MAX_DISPLAY_RECORD_COMPANY_NAME_LEN) ? '..' : '';
      $record_company_name = substr($result['record_company_name'], 0, (int)MAX_DISPLAY_RECORD_COMPANY_NAME_LEN) . $elipsis;

      $record_company_array[] = array('id' => $result['record_company_id'],
