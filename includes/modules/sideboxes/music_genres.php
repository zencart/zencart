...
// Display a list
    ...
    foreach ($music_genres as $next_genre) {
        ...
        if (mb_strlen($music_genre_name) > (int)zen_config('MAX_DISPLAY_MUSIC_GENRES_NAME_LEN')) {
            $music_genre_name = mb_substr($music_genre_name, 0, (int)zen_config('MAX_DISPLAY_MUSIC_GENRES_NAME_LEN')) . '..';
        }
        $music_genres_array[] = [
