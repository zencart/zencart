...
$reviews_query_raw = "SELECT r.reviews_id, rd.reviews_text, rd.reviews_title, r.reviews_rating, r.date_added, p.products_id, pd.products_name, p.products_image, r.customers_name
