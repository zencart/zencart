 ...
 */
  ...
  if (!defined('PRODUCT_THROWS_200_WHEN_DISABLED') || PRODUCT_THROWS_200_WHEN_DISABLED !== true) {
      if ($product_info->RecordCount() == 0 || $product_info->fields['products_status'] != 1) {
...
// if review must be approved or disabled do not show review
  ...
  $products_description = isset($product_info->fields['products_description']) ? ((!preg_match('/(<br|<p|<div|<dd|<li|<span)/i', $product_info->fields['products_description']) ? nl2br($product_info->fields['products_description']) : $product_info->fields['products_description'])) : '';

  if ((!isset($product_info->fields['products_image']) || $product_info->fields['products_image'] == '') && PRODUCTS_IMAGE_NO_IMAGE_STATUS == '1') {
    $products_image = PRODUCTS_IMAGE_NO_IMAGE;
  } else {
    $products_image = $product_info->fields['products_image'];
  }

  $products_url = isset($product_info->fields['products_url']) ? $product_info->fields['products_url'] : '';
  $products_date_available = isset($product_info->fields['products_date_available']) ? $product_info->fields['products_date_available'] : '';
  $products_date_added = isset($product_info->fields['products_date_added']) ? $product_info->fields['products_date_added'] : '';
  $products_manufacturer = isset($manufacturers_name) ? $manufacturers_name : '';
  $products_weight = isset($product_info->fields['products_weight']) ? $product_info->fields['products_weight'] : '';
  $products_quantity = isset($product_info->fields['products_quantity']) ? $product_info->fields['products_quantity'] : '';

  $products_qty_box_status = isset($product_info->fields['products_qty_box_status']) ? $product_info->fields['products_qty_box_status'] : '';
  $products_quantity_order_max = isset($product_info->fields['products_quantity_order_max']) ? $product_info->fields['products_quantity_order_max'] : '';
  ...
  $products_base_price = $currencies->display_price(zen_get_products_base_price((int)$_GET['products_id']),
                      zen_get_tax_rate(isset($product_info->fields['products_tax_class_id']) ? $product_info->fields['products_tax_class_id'] : 0));

  $product_is_free = isset($product_info->fields['product_is_free']) ? $product_info->fields['product_is_free'] : 0;

  $products_tax_class_id = isset($product_info->fields['products_tax_class_id']) ? $product_info->fields['products_tax_class_id'] : 0;
  ...
  $products_discount_type = isset($product_info->fields['products_discount_type']) ? $product_info->fields['products_discount_type'] : 0;
  $products_discount_type_from = isset($product_info->fields['products_discount_type_from']) ? $product_info->fields['products_discount_type_from'] : 0;
