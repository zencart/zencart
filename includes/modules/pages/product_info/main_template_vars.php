 ...
 */
  ...
  if ( $res->fields['total'] < 1 ) {
    ...
    if (!$flagHasCartContents) {
        $listingBoxManager = new ZenCart\ListingQueryAndOutput\Manager('MISSING_PRODUCT', new App\Model\ModelFactory($db, $capsule), $zcRequest);
...
// build show flags from product type layout settings
  ...
  $flag_show_product_info_manufacturer = zen_get_show_product_switch($_GET['products_id'], 'manufacturer') && !empty($manufacturers_name);
