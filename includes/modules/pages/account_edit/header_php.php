...
if (!empty($_POST['action']) && $_POST['action'] === 'process') {
    ...
    $customers_referral = '';
    if (zen_config('CUSTOMERS_REFERRAL_STATUS') === '2' && !empty($_POST['customers_referral']) ) {
    ...
    if (zen_config('ACCOUNT_DOB') === 'true' && (zen_config('ENTRY_DOB_MIN_LENGTH') > 0 || !empty($_POST['dob']))) {
