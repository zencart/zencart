...
$paypalec_enabled = (defined('MODULE_PAYMENT_PAYPALWPP_STATUS') && zen_config('MODULE_PAYMENT_PAYPALWPP_STATUS') == 'True' && defined('MODULE_PAYMENT_PAYPALWPP_ECS_BUTTON') && zen_config('MODULE_PAYMENT_PAYPALWPP_ECS_BUTTON') == 'On');
