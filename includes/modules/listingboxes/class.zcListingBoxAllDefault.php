 ...
 */
/**
 * class zcListingBoxAllDefault
 *
 * @package classes
 */
class zcListingBoxAllDefault extends zcAbstractListingBoxBase
{
  /**
   * (non-PHPdoc)
   *
  ...
  public function initProductQueryAndOutputLayout()
  {
    $this->productQuery = array(
        'isRandom' => FALSE,
        'isPaginated' => TRUE,
//        'paginatorScrollerTemplate' => 'tpl_paginator_standard.php',
        'filters' => array(
            array(
