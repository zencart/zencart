 ...
 * for the admin, the debug details are stored at: /logs/myDEBUG-adm-999999-00000000.log
 ...
 */
$debug_logfile_prefix = '/myDEBUG-';
if (IS_ADMIN_FLAG) {
    $debug_logfile_prefix = '/myDEBUG-adm-';
}
$debug_logfile_path = DIR_FS_LOGS . $debug_logfile_prefix . time() . '-' . mt_rand(1000, 999999) . '.log';
