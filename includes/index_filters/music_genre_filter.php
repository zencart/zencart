 ...
 * @version $Id: lat9 2025 Apr 29 Modified in v2.2.0 $
 */
/**
 * @var queryFactory $db
...
$listing_sql = "SELECT " . $select_column_list . " p.products_id, p.products_type, p.master_categories_id,
                       m.music_genre_id, p.products_price, p.products_tax_class_id, pd.products_description,
    ...
    if ((!isset($_GET['sort']))
        ...
        switch ($column_list[$sort_col - 1]) {
            ...
            case 'PRODUCT_LIST_MANUFACTURER':
                $order_by = " ORDER BY m.music_genre_name " . ($sort_order === 'd' ? 'DESC' : '') . ", pd.products_name";
                break;
...
$zco_notifier->notify('NOTIFY_PRODUCT_LISTING_QUERY_STRING', ['music_genre'], $listing_sql, $where_str, $order_by);
