...
$define = [
    ...
    'EMAIL_ORDER_MESSAGE' => '',
    'EMAIL_FOOTER_COPYRIGHT' => 'Copyright (c) ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '">' . zen_config('STORE_NAME') . '</a>. Powered by <a href="https://www.zen-cart.com">Zen Cart</a>',
    'TEXT_UNSUBSCRIBE' => "\n\nTo unsubscribe from future newsletter and promotional mailings, simply click on the following link: \n",
    'EMAIL_ADVISORY' => '-----' . "\n" . '<strong>IMPORTANT:</strong> For your protection and to prevent malicious use, all emails sent via this web site are logged and the contents recorded and available to the store owner. If you feel that you have received this email in error, please send an email to ' . zen_config('STORE_OWNER_EMAIL_ADDRESS') . "\n\n",
