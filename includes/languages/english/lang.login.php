...
$define = [
    ...
    'HEADING_NEW_CUSTOMER_SPLIT' => 'New Customers',
    'TEXT_NEW_CUSTOMER_INTRODUCTION' => 'Create a customer profile with <strong>' . STORE_NAME . '</strong> which allows you to shop faster, track the status of your current orders and review your previous orders.',
    'TEXT_NEW_CUSTOMER_INTRODUCTION_SPLIT' => 'Have a PayPal account? Want to pay quickly with a credit card? Use the PayPal button below to use the Express Checkout option.',
    'TEXT_NEW_CUSTOMER_POST_INTRODUCTION_DIVIDER' => '<span class="larger">Or</span><br>',
    'TEXT_NEW_CUSTOMER_POST_INTRODUCTION_SPLIT' => 'Create a Customer Profile with <strong>' . STORE_NAME . '</strong> which allows you to shop faster, track the status of your current orders, review your previous orders and take advantage of our other member\'s benefits.',
