...
$define = [
    ...
    'WARNING_CART_ITEM_LIMIT_REACHED' => 'Your shopping cart has reached the maximum number of different items allowed. Please remove an item before adding another.',
