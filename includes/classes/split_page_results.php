...
// -----
// Since the class, once defined, can't be overridden, issue
// a notification to see if an override is requested, loading
// the default class only if no override is active.
//
$override_spr_class = false;
$zco_notifier->notify('NOTIFY_SPLIT_PAGE_RESULTS_OVERRIDE', [], $override_spr_class);
if ($override_spr_class === false) {
    /**
