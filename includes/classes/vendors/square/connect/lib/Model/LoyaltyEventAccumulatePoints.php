...
use \ArrayAccess;
/**
 * LoyaltyEventAccumulatePoints Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltyEventAccumulatePoints implements ArrayAccess
{
    /**
    ...
    /**
     * Sets points
     * @param int $points The number of points accumulated by the event.
     * @return $this
     */
    ...
    /**
     * Sets order_id
     * @param string $order_id The ID of the `order` for which the buyer accumulated the points. This field is returned only if the Orders API is used to process orders.
     * @return $this
     */
