...
use \ArrayAccess;
/**
 * ListBankAccountsResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ListBankAccountsResponse implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'bank_accounts' => '\SquareConnect\Model\BankAccount[]',
        'cursor' => 'string'
    );
    ...
    /**
     * Sets bank_accounts
     * @param \SquareConnect\Model\BankAccount[] $bank_accounts List of BankAccounts associated with this account.
     * @return $this
     */
    ...
    /**
     * Sets cursor
     * @param string $cursor When a response is truncated, it includes a cursor that you can  use in a subsequent request to fetch next set of bank accounts. If empty, this is the final response.  For more information, see [Pagination](https://developer.squareup.com/docs/docs/working-with-apis/pagination).
     * @return $this
     */
