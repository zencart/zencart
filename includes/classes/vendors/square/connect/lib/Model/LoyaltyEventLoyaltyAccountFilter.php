...
use \ArrayAccess;
/**
 * LoyaltyEventLoyaltyAccountFilter Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltyEventLoyaltyAccountFilter implements ArrayAccess
{
    /**
     ...
     * @param string $loyalty_account_id The ID of the `loyalty account` associated with loyalty events.
     * @return $this
     */
