...
use \ArrayAccess;
/**
 * SearchTerminalCheckoutsResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class SearchTerminalCheckoutsResponse implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'checkouts' => '\SquareConnect\Model\TerminalCheckout[]',
        'cursor' => 'string'
    );
    ...
    protected $errors;
    /**
      * $checkouts The requested search result of `TerminalCheckout`s.
    ...
    /**
     * Sets checkouts
     * @param \SquareConnect\Model\TerminalCheckout[] $checkouts The requested search result of `TerminalCheckout`s.
     * @return $this
     */
