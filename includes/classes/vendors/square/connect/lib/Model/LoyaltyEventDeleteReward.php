...
use \ArrayAccess;
/**
 * LoyaltyEventDeleteReward Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltyEventDeleteReward implements ArrayAccess
{
    /**
    ...
    /**
      * $reward_id The ID of the deleted `loyalty reward`. This field is returned only if the event source is `LOYALTY_API`.
      * @var string
      */
    protected $reward_id;
    /**
    ...
    /**
     * Sets reward_id
     * @param string $reward_id The ID of the deleted `loyalty reward`. This field is returned only if the event source is `LOYALTY_API`.
     * @return $this
     */
    ...
    /**
     * Sets points
     * @param int $points The number of points returned to the loyalty account.
     * @return $this
     */
