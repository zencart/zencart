...
use \ArrayAccess;
/**
 * LoyaltyEventCreateReward Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltyEventCreateReward implements ArrayAccess
{
    /**
    ...
    /**
      * $reward_id The Square-assigned ID of the created `loyalty reward`. This field is returned only if the event source is `LOYALTY_API`.
      * @var string
      */
    protected $reward_id;
    /**
    ...
    /**
     * Sets reward_id
     * @param string $reward_id The Square-assigned ID of the created `loyalty reward`. This field is returned only if the event source is `LOYALTY_API`.
     * @return $this
     */
    ...
    /**
     * Sets points
     * @param int $points The loyalty points used to create the reward.
     * @return $this
     */
