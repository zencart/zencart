...
use \ArrayAccess;
/**
 * AccumulateLoyaltyPointsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AccumulateLoyaltyPointsRequest implements ArrayAccess
{
    /**
     ...
     * @param \SquareConnect\Model\LoyaltyEventAccumulatePoints $accumulate_points The points to add to the account.  If you are using the Orders API to manage orders, you   specify the order ID. Otherwise, specify the  points to add.
     * @return $this
     */
     ...
     * @param string $idempotency_key A unique string that identifies the `AccumulateLoyaltyPoints` request.  Keys can be any valid string but must be unique for every request.
     * @return $this
     */
    ...
    /**
     * Sets location_id
     * @param string $location_id The `location` where the purchase was made.
     * @return $this
     */
