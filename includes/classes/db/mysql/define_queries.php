 ...
 * @version $Id: define_queries.php drbyte  Modified in v1.5.5 $
 */
...
DEFINE('SQL_ALSO_PURCHASED', "SELECT p.products_id, p.products_image, o.date_purchased
                     ...
                     GROUP BY p.products_id, p.products_image, o.date_purchased desc
