...
class BaseLanguageLoader
{
     ...
     * the moment the file is require()'d, since it precedes the opening '<?php' tag. That silently
     * corrupts any output already in progress (e.g. an AJAX endpoint's JSON response). Logs a
     * warning identifying the offending file so it can be re-saved without a BOM.
     *
     * @since ZC v2.3.0
     */
