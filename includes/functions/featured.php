...
// Auto expire products on featured
  function zen_expire_featured() {
    ...
    $featured_query = "select featured_id
                       from " . TABLE_FEATURED . "
                       where status = '1'
                       and ((" . $zc_featured_date . " >= expires_date and expires_date != '1970-01-01')
                       or (" . $zc_featured_date . " < featured_date_available and featured_date_available != '1970-01-01'))";
...
// Auto start products on featured
  function zen_start_featured() {
    ...
    $featured_query = "select featured_id
                       from " . TABLE_FEATURED . "
                       where status = '0'
                       and (((featured_date_available <= " . $zc_featured_date . " and featured_date_available != '1970-01-01') and (expires_date > " . $zc_featured_date . "))
                       or ((featured_date_available <= " . $zc_featured_date . " and featured_date_available != '1970-01-01') and (expires_date = '1970-01-01'))
                       or (featured_date_available = '1970-01-01' and expires_date > " . $zc_featured_date . "))
                       ";
...
// turn off featured if not active yet
    $featured_query = "select featured_id
                       from " . TABLE_FEATURED . "
                       where status = '1'
                       and (" . $zc_featured_date . " < featured_date_available and featured_date_available != '1970-01-01')
                       ";
