...
// Auto expire products on special
  function zen_expire_specials() {
    ...
    $specials_query = "select specials_id, products_id
                       from " . TABLE_SPECIALS . "
                       where status = '1'
                       and ((" . $zc_specials_date . " >= expires_date and expires_date != '1970-01-01')
                       or (" . $zc_specials_date . " < specials_date_available and specials_date_available != '1970-01-01'))";
...
// turn on special if active
    $specials_query = "select specials_id, products_id
                       from " . TABLE_SPECIALS . "
                       where status = '0'
                       and (((specials_date_available <= " . $zc_specials_date . " and specials_date_available != '1970-01-01') and (expires_date > " . $zc_specials_date . "))
                       or ((specials_date_available <= " . $zc_specials_date . " and specials_date_available != '1970-01-01') and (expires_date = '1970-01-01'))
                       or (specials_date_available = '1970-01-01' and expires_date > " . $zc_specials_date . "))
                       ";
...
// turn off special if not active yet
    $specials_query = "select specials_id, products_id
                       from " . TABLE_SPECIALS . "
                       where status = '1'
                       and (" . $zc_specials_date . " < specials_date_available and specials_date_available != '1970-01-01')
                       ";
