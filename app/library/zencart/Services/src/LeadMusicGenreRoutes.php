...
/**
 * Class LeadMusicGenreRoutes
 * @package ZenCart\Services
 */
class LeadMusicGenreRoutes extends LeadRoutes
{
    /**
     * @return bool
     */
    public function deleteExecute()
    {
        ...
        if ($this->request->readPost('delete_linked') === 'true') {
            $sql = "SELECT products_id FROM " . TABLE_PRODUCT_MUSIC_EXTRA . " WHERE music_genre_id = :id:";
            ...
            $sql = "UPDATE " . TABLE_PRODUCT_MUSIC_EXTRA . " SET music_genre_id = '' WHERE music_genre_id = :id:";
            $sql = $this->dbConn->bindVars($sql, ':id:', $this->request->readPost('id'),
                $this->outputLayout ['fields'] [$mainTableFkeyField] ['bindVarsType']);
