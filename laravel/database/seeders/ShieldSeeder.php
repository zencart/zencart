...
class ShieldSeeder extends Seeder
{
    ...
    */
    public function run()
    {
        ...
        $rolesWithPermissions = '[{"name":"dashboard.user","guard_name":"web","permissions":[]},{"name":"developer.user","guard_name":"web","permissions":[]},{"name":"superadmin","guard_name":"web","permissions":[]}]';
        $directPermissions = '[]';
