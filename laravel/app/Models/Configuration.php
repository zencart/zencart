...
class Configuration extends Model
{
    ...
    public static function updateConfigurationValue(string $configKey, $configValue)
    {
        self::where('configuration_key', $configKey)->update(['configuration_value' => $configValue]);
    }
